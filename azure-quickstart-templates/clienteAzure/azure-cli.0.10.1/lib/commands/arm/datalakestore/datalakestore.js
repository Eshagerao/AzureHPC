...
exports.init = function(cli) {
  ...
  dataLakeStoreFileSystem.command("list [accountName] [path] [listSize]").description($("Lists the contents of the specified path (files and folders).")).usage("[options] <accountName> <path>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the folder to list (e.g. /someFolder or /someFolder/someNestedFolder)")).option("-l --listSize <listSize>", $("the optional number of entries to list. The default is all entries, which can potentially take some time for large directories.)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __1(accountName, path, listSize, options, _) { var subscription, client, parameters, fileStatuses; var __frame = { name: "__1", line: 59 }; return __func(_, this, arguments, __1, 4, __frame, function __$__1() {
  ...
  dataLakeStoreFileSystem.command("create [accountName] [path] [value] [folder] [force]").description($("Creates the specified folder or file, with the option to include content in file creation.")).usage("[options] <accountName> <path>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the file to add content to (e.g. /someFolder/someFile.txt)")).option("-v --value <value>", $("optional indicates the contents (as a string) to create the file with. NOTE: This parameter cannot be specified with --folder (-d)")).option("-d --folder", $("optionally specify that the item being created is a folder, not a file. If this is not specified, a file will be created. NOTE: This parameter cannot be specified with --encoding (-e) or --value (-v)")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __4(accountName, path, value, folder, force, options, _) { var subscription, clientOptions, client, result, parameters; var __frame = { name: "__4", line: 148 }; return __func(_, this, arguments, __4, 6, __frame, function __$__4() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription, clientOptions); return (function __$__4(__then) {
        ...
        if (folder) {
          return client.fileSystem.mkdirs(accountName, path, __cb(_, __frame, 21, 39, function ___(__0, __2) { result = __2;
          ...
          return withProgress(util.format($("Creating file %s"), path), function __1(log, _) { var __frame = { name: "__1", line: 186 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
              ...
              return client.fileSystem.create(accountName, path, parameters, __cb(_, __frame, 6, 28, function __$__1() { _(); }, true)); }); }, __cb(_, __frame, 37, 8, __then, true)); } ; })(function __$__4() {
  ...
  dataLakeStoreFileSystem.command("import [accountName] [path] [destination] [force]").description($("Uploads the specified the specified file, to the target destination in an Azure Data Lake. NOTE: Only text files are supported by this command at present.")).usage("[options] <accountName> <path> <destination>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full local path to the file to import (e.g. /someFolder/someFile.txt or C:somefoldersomeFile.txt)")).option("-d --destination <destination>", $("the full path in the Data Lake Store where the file should be imported to (e.g. /someFolder/someFile.txt")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __5(accountName, path, destination, force, options, _) { var subscription, clientOptions, client, parameters, fileStats; var __frame = { name: "__5", line: 207 }; return __func(_, this, arguments, __5, 5, __frame, function __$__5() {
      ...
      return fs.stat(path, __cb(_, __frame, 31, 25, function ___(__0, __2) { fileStats = __2;
        ...
        return withProgress(util.format($("Uploading file %s to the Data Lake Store location: %s"), path, destination), function __1(log, _) { var fileSizeInBytes, maxBytesToRead, fileHandle, offset, bytesToRead, buffer; var __frame = { name: "__1", line: 244 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
                        ...
                        var __3 = (offset < fileSizeInBytes); if (__3) {
                          ...
                          return fs.read(fileHandle, buffer, 0, bytesToRead, offset, __cb(_, __frame, 14, 15, function __$__1() { return (function __$__1(__then) {
                              ...
                              if ((offset === 0)) {
                                ...
                                return client.fileSystem.create(accountName, destination, parameters, __cb(_, __frame, 18, 32, __then, true)); } else {


                                return client.fileSystem.append(accountName, destination, buffer, __cb(_, __frame, 21, 32, __then, true)); } ; })(function __$__1() {
  ...
  dataLakeStoreFileSystem.command("concat [accountName] [paths] [destination] [force]").description($("Concatenates the specified list of files into the specified destination file.")).usage("[options] <accountName> <paths> <destination>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --paths <paths>", $("a comma seperated list of full paths to concatenate (e.g. '/someFolder/someFile.txt,/somefolder/somefile2.txt,/anotherFolder/newFile.txt')")).option("-d --destination <destination>", $("specify the target file that all of the files in --paths should be concatenated into (e.g /someFolder/targetFile.txt)")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __6(accountName, paths, destination, force, options, _) { var subscription, client, fileStatus, pathsBuf; var __frame = { name: "__6", line: 287 }; return __func(_, this, arguments, __6, 5, __frame, function __$__6() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription); return (function __$__6(__then) {
        ...
        if (force) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
                ...
                return client.fileSystem.getFileStatus(accountName, destination, __cb(_, __frame, 18, 45, function ___(__0, __2) { fileStatus = __2.fileStatus; return (function __$__6(__then) {
                    if ((fileStatus.type.toLowerCase() === "file")) {
                      return client.fileSystem.deleteMethod(accountName, destination, false, __cb(_, __frame, 20, 30, __then, true)); } else {
        ...
        return withProgress(util.format($("Concatenating specified files into target location: %s"), destination), function __1(log, _) { var __frame = { name: "__1", line: 320 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

            return client.fileSystem.msConcat(accountName, destination, pathsBuf, false, __cb(_, __frame, 1, 28, function __$__1() { _(); }, true)); }); }, __cb(_, __frame, 32, 6, function __$__6() {

          log.info($(("Successfully concatenated the file list into the specified item at path:  " + destination))); _(); }, true)); }); }); });


  dataLakeStoreFileSystem.command("move [accountName] [path] [destination] [force]").description($("Moves (renames) the specified file or folder into the specified destination file or folder.")).usage("[options] <accountName> <path> <destination>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the path to the file or folder to move (e.g. /someFolder or /someFolder/someFile.txt)")).option("-d --destination <destination>", $("specify the target location to move the file or folder to")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __7(accountName, path, destination, force, options, _) { var subscription, client; var __frame = { name: "__7", line: 334 }; return __func(_, this, arguments, __7, 5, __frame, function __$__7() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription); return (function __$__7(__then) {
        ...
        if (force) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__7() {
                ...
                return client.fileSystem.deleteMethod(accountName, destination, true, __cb(_, __frame, 18, 28, __then, true)); }); })(function ___(err, __result) { __catch(function __$__7() { if (err) { __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(function __$__7() {
  ...
  dataLakeStoreFileSystem.command("addcontent [accountName] [path] [value]").description($("Appends the specified content to the end of the Data Lake Store file path specified.")).usage("[options] <accountName> <path> <value>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the file to add content to (e.g. /someFolder/someFile.txt)")).option("-v --value <value>", $("the contents to append to the file")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __8(accountName, path, value, options, _) { var subscription, clientOptions, client; var __frame = { name: "__8", line: 370 }; return __func(_, this, arguments, __8, 4, __frame, function __$__8() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription, clientOptions);
      return withProgress(util.format($("Adding specified content to file %s"), path), function __1(log, _) { var __frame = { name: "__1", line: 391 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          return client.fileSystem.append(accountName, path, value, __cb(_, __frame, 1, 26, function __$__1() { _(); }, true)); }); }, __cb(_, __frame, 20, 6, function __$__8() {

        log.info($(("Successfully appended content at the specified path:  " + path))); _(); }, true)); }); });


  dataLakeStoreFileSystem.command("export [accountName] [path] [destination] [force]").description($("Downloads the specified file to the target location. NOTE: Only text files are supported by this command at present.")).usage("[options] <accountName> <path> <destination>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path in the Data Lake Store where the file should be imported to (e.g. /someFolder/someFile.txt")).option("-d --destination <destination>", $("the full local path to the file to import (e.g. /someFolder/someFile.txt or C:somefoldersomeFile.txt)")).option("-f --force", $("optionally indicates that the file being created can overwrite the file at path if it already exists (default is false).")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __9(accountName, path, destination, force, options, _) { var subscription, client, maxBytesToRead, fileStatus; var __frame = { name: "__9", line: 405 }; return __func(_, this, arguments, __9, 5, __frame, function __$__9() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription);
      maxBytesToRead = ((4 * 1024) * 1024);
      return client.fileSystem.getFileStatus(accountName, path, __cb(_, __frame, 16, 41, function ___(__0, __2) { fileStatus = __2.fileStatus;

        return withProgress(util.format($("Downloading file %s to the specified location: %s"), path, destination), function __1(log, _) { var fileSizeInBytes, fileHandle, offset, bytesToRead, parameters, response, buff; var __frame = { name: "__1", line: 424 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
                ...
                return fs.open(destination, "w", __cb(_, __frame, 4, 26, function ___(__0, __1) { fileHandle = __1; __then(); }, true)); } else { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                      ...
                      return fs.open(destination, "wx", __cb(_, __frame, 8, 28, function ___(__0, __2) { fileHandle = __2; __then(); }, true)); }); })(function ___(err, __result) { __catch(function __$__1() { if (err) {
                        ...
                        return _(new Error($(((("The file at path: " + destination) + " already exists. Please use the --force option to overwrite this file. Actual error reported: ") + err)))); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, __then); }); } ; })(function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                          ...
                          offset = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__1() { __more = false;
                              var __7 = (offset < fileSizeInBytes); if (__7) {
                                bytesToRead = maxBytesToRead;
                                if (((offset + maxBytesToRead) > fileSizeInBytes)) {
                                  bytesToRead = (fileSizeInBytes - offset); } ;
                                ...
                                return client.fileSystem.open(accountName, path, parameters, __cb(_, __frame, 27, 45, function ___(__0, __3) { response = __3;
  ...
  dataLakeStoreFileSystem.command("read [accountName] [path] [length] [offset]").description($("Previews the specified Data Lake Store file starting at index 0 (or the specified offset) until the length is reached, displaying the results to the console.")).usage("[options] <accountName> <path> <length>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the file to download (e.g. /someFolder/someFile.txt)")).option("-l --length <length>", $("the length, in bytes, to read from the file")).option("-o --offset <offset>", $("the optional offset to begin reading at (default is 0)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __10(accountName, path, length, offset, options, _) { var parameters, subscription, response, buff; var __frame = { name: "__10", line: 476 }; return __func(_, this, arguments, __10, 5, __frame, function __$__10() {
      ...
      return withProgress(util.format($("Previewing contents of file %s"), path), function __1(log, _) { var client; var __frame = { name: "__1", line: 507 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          client = utils.createDataLakeStoreFileSystemManagementClient(subscription);
          return client.fileSystem.open(accountName, path, parameters, __cb(_, __frame, 2, 37, function ___(__0, __1) { response = __1; _(); }, true)); }); }, __cb(_, __frame, 30, 6, function __$__10() {


        return readStreamToBuffer(response, __cb(_, __frame, 36, 17, function ___(__0, __2) { buff = __2;
          log.data(buff); _(); }, true)); }, true)); }); });
  ...
  dataLakeStoreFileSystemPermissions.command("show [accountName] [path]").description($("Gets the specified Data Lake Store folder ACL")).usage("[options] <accountName> <path>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the folder or file to get (e.g. /someFolder or /someFolder/someFile.txt)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __11(accountName, path, options, _) { var subscription, client, aclStatus; var __frame = { name: "__11", line: 525 }; return __func(_, this, arguments, __11, 3, __frame, function __$__11() {
      ...
      return client.fileSystem.getAclStatus(accountName, path, __cb(_, __frame, 12, 40, function ___(__0, __1) { aclStatus = __1.aclStatus;
  ...
  dataLakeStoreFileSystemPermissions.command("set [accountName] [path] [aclSpec]").description($("sets the specified Data Lake Store folder ACL (overwriting the previous ACL entries)")).usage("[options] <accountName> <path> <aclSpec>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the folder to remove ACLs from (e.g. /someFolder)")).option("-a --aclSpec <aclSpec>", $("a comma delimited list of fully qualified ACL entries to set in the format [default:]<user>|<group>:<object Id>:<permissions> (e.g 'user:5546499e-795f-4f5f-b411-8179051f8b0a:r-x' or 'default:group:5546499e-795f-4f5f-b411-8179051f8b0a:rwx'). This list must also include default entries (no object ID in the middle)")).option("-q, --quiet", $("quiet mode (do not ask for overwrite confirmation)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __14(accountName, path, aclSpec, options, _) { var subscription, client; var __frame = { name: "__14", line: 651 }; return __func(_, this, arguments, __14, 4, __frame, function __$__14() {
      ...
      if (!aclSpec) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Overwrite existing Data Lake Store ACL with the following ACL: %s for account %s at path %s? [y/n] "), aclSpec, accountName, path), __cb(_, __frame, 13, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -650, 17, function ___(__0, __2) { return (function __$__14(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__14() {
          ...
          return client.fileSystem.setAcl(accountName, path, aclSpec, __cb(_, __frame, 20, 24, function __$__14() {
  ...
  dataLakeStoreAccount.command("list [resource-group]").description($("List all Data Lake Store accounts available for your subscription or subscription and resource group")).usage("[options]").option("-g --resource-group <resource-group>", $("the optional resource group to list the accounts in")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __15(resourceGroup, options, _) { var subscription, accounts; var __frame = { name: "__15", line: 683 }; return __func(_, this, arguments, __15, 2, __frame, function __$__15() {
  ...
  dataLakeStoreAccount.command("show [accountName] [resource-group]").description($("Shows a Data Lake Store Account based on account name")).usage("[options] <accountName>").option("-n --accountName <accountName>", $("the Data Lake Store account name")).option("-g --resource-group <resource-group>", $("the optional resource group to list the accounts in")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __16(accountName, resourceGroup, options, _) { var subscription, client, dataLakeStoreAccount; var __frame = { name: "__16", line: 695 }; return __func(_, this, arguments, __16, 3, __frame, function __$__16() {
      ...
      subscription = profile.current.getSubscription(options.subscription);
      client = utils.createDataLakeStoreManagementClient(subscription); return (function __$__16(__then) {

        if (!resourceGroup) {
          return getResrouceGroupByAccountName(subscription, resourceGroup, accountName, __cb(_, __frame, 9, 24, function ___(__0, __1) { resourceGroup = __1; __then(); }, true)); } else { __then(); } ; })(function __$__16() {


        return client.account.get(resourceGroup, accountName, __cb(_, __frame, 12, 48, function ___(__0, __2) { dataLakeStoreAccount = __2;

          dataLakeStoreUtils.formatOutput(cli, log, options, dataLakeStoreAccount); _(); }, true)); }); }); });


  dataLakeStoreAccount.command("delete [accountName] [resource-group]").description($("Deletes a Data Lake Store Account based on account name")).usage("[options] <accountName>").option("-n --accountName <accountName>", $("the Data Lake Store account name")).option("-g --resource-group <resource-group>", $("the optional resource group to force the command to find the Data Lake Store account to delete in.")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __17(accountName, resourceGroup, options, _) { var subscription, client; var __frame = { name: "__17", line: 719 }; return __func(_, this, arguments, __17, 3, __frame, function __$__17() {
      ...
      if (!accountName) {
        return _(null, cli.missingArgument("accountName")); } ; return (function __$__17(_) {


        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete Data Lake Store Account %s? [y/n] "), accountName), __cb(_, __frame, 5, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -718, 17, function ___(__0, __2) { return (function __$__17(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__17() {
  ...
  dataLakeStoreAccount.command("set [accountName] [resource-group] [defaultGroup]").description($("Updates the properties of an existing Data Lake Store Account")).usage("[options] <accountName>").option("-n --accountName <accountName>", $("The Data Lake Store account name to update with new tags and/or default permissions group")).option("-g --resource-group <resource-group>", $("the optional resource group to forcibly look for the account to update in")).option("-d --defaultGroup <defaultGroup>", $("the optional default permissions group to set in the existing account")).option("-t --tags <tags>", $(("Tags to set to the Data Lake Store account. Can be mutliple. " + "In the format of 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2"))).option("--no-tags", $("remove all existing tags")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __19(accountName, resourceGroup, defaultGroup, options, _) { var subscription, client, dataLakeStoreAccount, tags; var __frame = { name: "__19", line: 768 }; return __func(_, this, arguments, __19, 4, __frame, function __$__19() {
      ...
      subscription = profile.current.getSubscription(options.subscription);
      client = utils.createDataLakeStoreManagementClient(subscription); return (function __$__19(__then) {

        if (!resourceGroup) {
          return getResrouceGroupByAccountName(subscription, resourceGroup, accountName, __cb(_, __frame, 5, 24, function ___(__0, __1) { resourceGroup = __1; __then(); }, true)); } else { __then(); } ; })(function __$__19() {


        return client.account.get(resourceGroup, accountName, __cb(_, __frame, 8, 48, function ___(__0, __2) { dataLakeStoreAccount = __2;
  ...
  function createOrUpdateDataLakeStoreAccount(subscription, accountName, resourceGroup, location, defaultGroup, tags, _) { var client, create, accountParams; var __frame = { name: "createOrUpdateDataLakeStoreAccount", line: 794 }; return __func(_, this, arguments, createOrUpdateDataLakeStoreAccount, 6, __frame, function __$createOrUpdateDataLakeStoreAccount() {
      if (!accountName) {
        return _(null, cli.missingArgument("accountName")); } ;
      ...
      create = false; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createOrUpdateDataLakeStoreAccount() {
            ...
            return client.account.get(resourceGroup, accountName, __cb(_, __frame, 14, 23, __then, true)); }); })(function ___(err, __result) { __catch(function __$createOrUpdateDataLakeStoreAccount() { if (err) {
          ...
          accountParams = {
            ...
            if (create) {
              return client.account.create(resourceGroup, accountParams.name, accountParams, __cb(_, __frame, 30, 23, __then, true)); } else {


              return client.account.update(resourceGroup, accountParams.name, accountParams, __cb(_, __frame, 33, 23, __then, true)); } ; })(function __$createOrUpdateDataLakeStoreAccount() {


            return client.account.get(resourceGroup, accountName, __cb(_, __frame, 36, 28, _, true)); }); }); }); }); };


  function listAllDataLakeStoreAccounts(subscription, resourceGroup, _) { var client, response, accounts; var __frame = { name: "listAllDataLakeStoreAccounts", line: 833 }; return __func(_, this, arguments, listAllDataLakeStoreAccounts, 2, __frame, function __$listAllDataLakeStoreAccounts() {
      client = utils.createDataLakeStoreManagementClient(subscription); return (function __$listAllDataLakeStoreAccounts(__then) {


        if (!resourceGroup) {
          return client.account.list(resourceGroup, __cb(_, __frame, 5, 32, function ___(__0, __1) { response = __1;
            accounts = response;
          ...
          return client.account.listByResourceGroup(resourceGroup, __cb(_, __frame, 13, 32, function ___(__0, __2) { response = __2;
            accounts = response;
            while (response.nextLink) {
              response = client.account.listByResourceGroupNext(response.nextLink);
              accounts.push.apply(accounts, response); }; __then(); }, true)); } ; })(function __$listAllDataLakeStoreAccounts() {
  ...
  function getResrouceGroupByAccountName(subscription, resourceGroup, name, _) { var accounts, i, acctId, rgStart, rgEnd; var __frame = { name: "getResrouceGroupByAccountName", line: 857 }; return __func(_, this, arguments, getResrouceGroupByAccountName, 3, __frame, function __$getResrouceGroupByAccountName() {
