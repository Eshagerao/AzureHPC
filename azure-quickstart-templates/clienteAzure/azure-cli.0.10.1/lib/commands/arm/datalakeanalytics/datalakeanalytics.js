...
exports.init = function(cli) {
  ...
  dataLakeAnalyticsJob.command("create [accountName] [jobName] [script] [runtime] [compileMode] [compileOnly] [degreeOfParallelism] [priority]").description($("Submits a job to the specified Data Lake Analytics account.")).usage("[options] <accountName> <jobName> <script>").option("-n --accountName <accountName>", $("the Data Lake Analytics account name to execute the action on")).option("-j --jobName <jobName>", $("the name for this job submission")).option("-t --script <script>", $("the script to run. This can be either the script contents, a relative path or the full path to a UTF-8 encoded script file")).option("-r --runtime <runtime>", $(("optionally indicates the runtime to use. The default runtime is the currently deployed production runtime." + "Use this if you have uploaded a custom runtime to your account and want job execution to go through that one instead of the one deployed by Microsoft."))).option("-m --compileMode <compileMode>", $("optionally specify the type of compilation to do. Valid values are 'Semantic', 'Full', and 'SingleBox' Default is Full.")).option("-c --compileOnly <compileOnly>", $("optionally indicates that this job should only be compiled and not run.")).option("-d --degreeOfParallelism <degreeOfParallelism>", $("optionally specify the degree of parallelism for the job in a range from 1 to 50. Default value is 1.")).option("-p --priority <priority>", $("optionally specify the priority for the job. Default value is 1000, with lower, positive, non-zero values having higher priority. 1 is the highest priority and int.maxValue is the lowest.")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __1(accountName, jobName, script, runtime, compileMode, compileOnly, degreeOfParallelism, priority, options, _) { var subscription, client, scriptAsPath, scriptContents, normalPath, job, properties, jobResponse; var __frame = { name: "__1", line: 58 }; return __func(_, this, arguments, __1, 9, __frame, function __$__1() {
      ...
      scriptAsPath = true; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
            ...
            return fs.readFile(normalPath, "utf8", __cb(_, __frame, 21, 28, function ___(__0, __1) { scriptContents = __1; __then(); }, true)); }); })(function ___(err, __result) { __catch(function __$__1() { if (err) {
          ...
          jobResponse = { }; return (function __$__1(__then) {
            if (compileOnly) {
              return client.job.build(accountName, job, __cb(_, __frame, 75, 33, function ___(__0, __2) { jobResponse = __2; __then(); }, true)); } else {


              return client.job.create(accountName, job.jobId, job, __cb(_, __frame, 78, 33, function ___(__0, __3) { jobResponse = __3; __then(); }, true)); } ; })(function __$__1() {


            dataLakeAnalyticsUtils.formatOutput(cli, log, options, jobResponse); _(); }); }); }); }); });


  dataLakeAnalyticsJob.command("show [accountName] [jobId] [includeDebugInfo] [includeStatistics]").description($("shows the specified job and additional data if desired.")).usage("[options] <accountName> <jobId>").option("-n --accountName <accountName>", $("the Data Lake Analytics account name to execute the action on")).option("-j --jobId <jobId>", $("the job ID of the job to retrieve.")).option("-d --includeDebugInfo", $("optionally indicates that debug info should be output for the job as well.")).option("-t --includeStatistics", $("optionally indicates that statistics for the job should be output as well.")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __2(accountName, jobId, includeDebugInfo, includeStatistics, options, _) { var subscription, client, jobResponse, statistics, debugData; var __frame = { name: "__2", line: 150 }; return __func(_, this, arguments, __2, 5, __frame, function __$__2() {
      ...
      return client.job.get(accountName, jobId, __cb(_, __frame, 12, 35, function ___(__0, __1) { jobResponse = __1; return (function __$__2(__then) {

          if (includeStatistics) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                  return client.job.getStatistics(accountName, jobId, __cb(_, __frame, 16, 38, function ___(__0, __2) { statistics = __2;
            ...
            if (includeDebugInfo) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                    ...
                    return client.job.getDebugDataPath(accountName, jobId, __cb(_, __frame, 26, 37, function ___(__0, __3) { debugData = __3.paths;
  ...
  dataLakeAnalyticsJob.command("list [accountName] [jobName] [submitter] [submittedAfter] [submittedBefore] [state] [result]").description($("lists the jobs in the specified account given the specified filters and criteria.")).usage("[options] <accountName>").option("-n --accountName <accountName>", $("the Data Lake Analytics account name to execute the action on")).option("-j --jobName <jobName>", $("An optional filter which returns jobs with only the specified friendly name.")).option("-u, --submitter <submitter>", $("An optional filter which returns jobs only by the specified submitter in the format user@domain")).option("-a, --submittedAfter <submittedAfter>", $("An optional filter which returns jobs only submitted after the specified time (as a date time offset).")).option("-b, --submittedBefore <submittedAfter>", $("An optional filter which returns jobs only submitted before the specified time (as a date time offset).")).option("-t, --state <comma delmited string of states>", $(("An optional filter which returns jobs with only the specified states (as comma delmited string). Valid states are: " + "accepted, compiling, ended, new, queued, running, scheduling, starting and paused"))).option("-r, --result <comma delmited string of results>", $(("An optional filter which returns jobs with only the specified results (as comma delmited string). Valid results are: " + "none, succeeded, cancelled and failed"))).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __4(accountName, jobName, submitter, submittedAfter, submittedBefore, state, result, options, _) { var subscription, client, filter, intermediateStateArray, stateString, stateArray, i, intermediateResultArray, resultString, resultArray, j, parameters, filterString, jobList; var __frame = { name: "__4", line: 228 }; return __func(_, this, arguments, __4, 8, __frame, function __$__4() {
      ...
      return withProgress(util.format($("Retrieving job list for account: %s"), accountName), function __1(log, _) { var response, pushJobs; var __frame = { name: "__1", line: 288 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          return client.job.list(accountName, parameters, __cb(_, __frame, 1, 36, function ___(__0, __1) { response = __1;
            jobList = response;
            pushJobs = function(eachValue) { jobList.push(eachValue); }; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__1() { __more = false;
                var __4 = (response.nextLink && (response.nextLink.length > 0)); if (__4) {
                  return client.job.listNext(response.nextLink, __cb(_, __frame, 5, 34, function ___(__0, __2) { response = __2;
                    response.forEach(pushJobs, jobList); while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(_); }, true)); }); }, __cb(_, __frame, 59, 6, function __$__4() {
  ...
  dataLakeAnalyticsCatalog.command("list [accountName] [itemType] [itemPath]").description($("Lists all of the specified catalog item types under the path or, if the full path is given, just the single catalog item at that path.")).usage("[options] <accountName> <itemType> <itemPath>").option("-n --accountName <accountName>", $("The Data Lake Analytics account name to perform the action on.")).option("-t --itemType <itemType>", $("The catalog item type to return. Valid values are (case insensitive): database, schema, secret, credential, assembly, externaldatasource, table, tablevaluedfunction, view, procedure, types or tablestatistics")).option("-p --itemPath <itemPath>", $("The path to the catalog item(s) to get or list in the format: <FirstPart>.<OptionalSecondPart>.<OptionalThirdPart>.<OptionalFourthPart>. This MUST be null when listing all databases.")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __5(accountName, itemType, itemPath, options, _) { var subscription, output; var __frame = { name: "__5", line: 311 }; return __func(_, this, arguments, __5, 4, __frame, function __$__5() {
      ...
      return getCatalogItem(subscription, accountName, itemPath, itemType, __cb(_, __frame, 11, 19, function ___(__0, __1) { output = __1;
  ...
  dataLakeAnalyticsCatalogSecret.command("create [accountName] [databaseName] [hostUri] [secretName]").description($("Creates the specified secret for the specified database.")).usage("[options] <accountName> <databaseName> <hostUri> <secretName>").option("-n --accountName <accountName>", $("The Data Lake Analytics account name to perform the action on.")).option("-d --databaseName <databaseName>", $("The name of the database in which the secret will be created.")).option("-u --hostUri <hostUri>", $("The full host URI associated with the external data source. The secret will be used with this host URI.")).option("-e --secretName <secretName>", $("secret name, will prompt if not given")).option("-p --password <password>", $("secret password, will prompt if not given")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __6(accountName, databaseName, hostUri, secretName, options, _) { var subscription, password, client, params, response; var __frame = { name: "__6", line: 338 }; return __func(_, this, arguments, __6, 5, __frame, function __$__6() {
      ...
      return cli.interaction.promptIfNotGiven("SecretName: ", secretName, __cb(_, __frame, 15, 35, function ___(__0, __1) { secretName = __1;
        return cli.interaction.promptPasswordOnceIfNotGiven("Password: ", options.password, __cb(_, __frame, 16, 37, function ___(__0, __2) { password = __2;
          ...
          return client.catalog.createSecret(accountName, databaseName, params.secretName, params, __cb(_, __frame, 25, 36, function ___(__0, __3) { response = __3;
  ...
  dataLakeAnalyticsCatalogSecret.command("delete [accountName] [databaseName] [secretName]").description($("Updates the password and/or hostUri of the specified secret in the specified database.")).usage("[options] <accountName> <databaseName> <hostUri> <secretName>").option("-n --accountName <accountName>", $("The Data Lake Analytics account name to perform the action on.")).option("-d --databaseName <databaseName>", $("The name of the database in which the secret(s) will be deleted.")).option("-e --secretName <secretName>", $("Optional secret name to delete, if not specified will delete all secrets in the specified database")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __8(accountName, databaseName, secretName, options, _) { var subscription, client; var __frame = { name: "__8", line: 413 }; return __func(_, this, arguments, __8, 4, __frame, function __$__8() {
      ...
      if (!databaseName) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete Secret(s) in database %s? [y/n] "), databaseName), __cb(_, __frame, 9, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -412, 17, function ___(__0, __2) { return (function __$__8(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__8() {
          ...
          client = utils.createDataLakeAnalyticsCatalogManagementClient(subscription); return (function __$__8(__then) {

            if (!secretName) {
              return client.catalog.deleteAllSecrets(accountName, databaseName, __cb(_, __frame, 18, 23, __then, true)); } else {


              return client.catalog.deleteSecret(accountName, databaseName, secretName, __cb(_, __frame, 21, 23, __then, true)); } ; })(_); }); }, true)); }); });
  ...
  dataLakeAnalyticsAccount.command("show [accountName] [resource-group]").description($("Shows a Data Lake Analytics account based on account name")).usage("[options] <accountName>").option("-n --accountName <accountName>", $("the Data Lake Analytics account name to retrieve")).option("-g --resource-group <resource-group>", $("the optional resource group to list the accounts in")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __10(accountName, resourceGroup, options, _) { var subscription, client, dataLakeAnalyticsAccount; var __frame = { name: "__10", line: 458 }; return __func(_, this, arguments, __10, 3, __frame, function __$__10() {
      ...
      client = utils.createDataLakeAnalyticsManagementClient(subscription); return (function __$__10(__then) {
        ...
        return client.account.get(resourceGroup, accountName, __cb(_, __frame, 12, 52, function ___(__0, __2) { dataLakeAnalyticsAccount = __2;
  ...
  dataLakeAnalyticsAccount.command("set [accountName] [resource-group] [defaultDataLakeStore]").description($("Updates the properties of an existing Data Lake Analytics Account")).usage("[options] <accountName> <defaultDataLakeStore>").option("-n --accountName <accountName>", $("The Data Lake Analytics Account name to perform the action on.")).option("-g --resource-group <resource-group>", $("the optional resource group to forcibly look for the account to update in")).option("-g --resource-group <resource-group>", $("the optional resource group to forcibly look for the account to update in")).option("-d --defaultDataLakeStore <defaultDataLakeStore>", $("the optional new default Data Lake Store account to set for this account")).option("-t --tags <tags>", $(("Tags to set to the Data Lake Analytics account group. Can be mutliple. " + "In the format of 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2"))).option("--no-tags", $("remove all existing tags")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __13(accountName, resourceGroup, defaultDataLakeStore, options, _) { var subscription, client, dataLakeAnalyticsAccount, tags; var __frame = { name: "__13", line: 530 }; return __func(_, this, arguments, __13, 4, __frame, function __$__13() {
      ...
      client = utils.createDataLakeAnalyticsManagementClient(subscription); return (function __$__13(__then) {
        ...
        return client.account.get(resourceGroup, accountName, __cb(_, __frame, 8, 52, function ___(__0, __2) { dataLakeAnalyticsAccount = __2;
      ...
      if ((azureBlob && isDefaultDataLakeStore)) {
        ...
        parameters = { }; return (function __$__14(__then) {
          if (dataLakeStore) {
            ...
            return client.account.addDataLakeStoreAccount(resourceGroup, accountName, dataLakeStore, parameters, __cb(_, __frame, 31, 23, __then, true)); } else {
            ...
            return client.account.addStorageAccount(resourceGroup, accountName, azureBlob, parameters, __cb(_, __frame, 38, 23, __then, true)); } ; })(function __$__14() { return (function __$__14(__then) {


            if (isDefaultDataLakeStore) {
              return createOrUpdateDataLakeAnalyticsAccount(subscription, accountName, resourceGroup, null, dataLakeStore, null, __cb(_, __frame, 42, 8, __then, true)); } else { __then(); } ; })(function __$__14() {


            log.info($(("Successfully added the storage account specified to the Data Lake Analytics account: " + accountName))); _(); }); }); }); }); });


  dataLakeAnalyticsAccountDataSource.command("delete [accountName] [dataLakeStore] [azureBlob] [resource-group]").description($("removes a data source (Data Lake Store or Azure Blob) from the Data Lake Analytics Account")).usage("[options] <accountName>").option("-n --accountName <accountName>", $("The Data Lake Analytics Account name to perform the action on.")).option("-l --dataLakeStore <dataLakeStore>", $("the Data Lake to remove from the account. NOTE: this argument is part of a parameter set, and cannot be specified with --azureBlob.")).option("-b --azureBlob <azureBlob>", $("the azure blob to remove from the account. NOTE: this argument is part of a parameter set, and cannot be specified with --dataLakeStore.")).option("-g --resource-group <resource-group>", $("the optional resource group to forcibly look for the account to update in")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __15(accountName, dataLakeStore, azureBlob, resourceGroup, options, _) { var subscription, client; var __frame = { name: "__15", line: 625 }; return __func(_, this, arguments, __15, 5, __frame, function __$__15() {
      ...
      if ((azureBlob && isDefaultDataLakeStore)) {
        ...
        if (!resourceGroup) {
          ...
          if (dataLakeStore) { return (function __$__16(__then) {
            ...
            return client.account.updateStorageAccount(resourceGroup, accountName, azureBlob, parameters, __cb(_, __frame, 43, 23, __then, true)); } ; })(function __$__16() {
  ...
  function createOrUpdateDataLakeAnalyticsAccount(subscription, accountName, resourceGroup, location, defaultDataLakeStore, tags, _) { var client, create, accountParams; var __frame = { name: "createOrUpdateDataLakeAnalyticsAccount", line: 710 }; return __func(_, this, arguments, createOrUpdateDataLakeAnalyticsAccount, 6, __frame, function __$createOrUpdateDataLakeAnalyticsAccount() {
      ...
      create = false; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createOrUpdateDataLakeAnalyticsAccount() {
            ...
            return client.account.get(resourceGroup, accountName, __cb(_, __frame, 11, 23, __then, true)); }); })(function ___(err, __result) { __catch(function __$createOrUpdateDataLakeAnalyticsAccount() { if (err) {
          ...
          accountParams = {
            ...
            if (create) {
              ...
              return client.account.create(resourceGroup, accountParams.name, accountParams, __cb(_, __frame, 35, 23, __then, true)); } else {
              ...
              return client.account.update(resourceGroup, accountParams.name, accountParams, __cb(_, __frame, 42, 23, __then, true)); } ; })(function __$createOrUpdateDataLakeAnalyticsAccount() {


            return client.account.get(resourceGroup, accountName, __cb(_, __frame, 45, 28, _, true)); }); }); }); }); };


  function getCatalogItem(subscription, accountName, itemPath, itemType, _) { var isList, client, catalogItem, toReturn; var __frame = { name: "getCatalogItem", line: 758 }; return __func(_, this, arguments, getCatalogItem, 4, __frame, function __$getCatalogItem() {
      ...
      toReturn = []; return (function __$getCatalogItem(__break) {
        ...
        case "database": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listDatabases(accountName, __cb(_, __frame, 9, 38, function ___(__0, __1) {
                toReturn = __1; __then(); }, true)); } else { return client.catalog.getDatabase(accountName, catalogItem.databaseName, __cb(_, __frame, 12, 41, function ___(__0, __2) {
        ...
        case "schema": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listSchemas(accountName, catalogItem.databaseName, __cb(_, __frame, 17, 38, function ___(__0, __3) {
                toReturn = __3; __then(); }, true)); } else { return client.catalog.getSchema(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 20, 41, function ___(__0, __4) {
        ...
        case "secret": return (function __$getCatalogItem(__then) { if (isList) {
            ...
            } else { return client.catalog.getSecret(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 28, 41, function ___(__0, __5) {
        ...
        case "assembly": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listAssemblies(accountName, catalogItem.databaseName, __cb(_, __frame, 34, 38, function ___(__0, __6) {
                toReturn = __6; __then(); }, true)); } else { return client.catalog.getAssembly(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 37, 41, function ___(__0, __7) {
        ...
        case "externaldatasource": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listExternalDataSources(accountName, catalogItem.databaseName, __cb(_, __frame, 42, 38, function ___(__0, __8) {
                toReturn = __8; __then(); }, true)); } else { return client.catalog.getExternalDataSource(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 45, 41, function ___(__0, __9) {
        ...
        case "credential": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listCredentials(accountName, catalogItem.databaseName, __cb(_, __frame, 50, 38, function ___(__0, __10) {
                toReturn = __10; __then(); }, true)); } else { return client.catalog.getCredential(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 53, 41, function ___(__0, __11) {
        ...
        case "table": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listTables(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 58, 38, function ___(__0, __12) {
                toReturn = __12; __then(); }, true)); } else { return client.catalog.getTable(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, __cb(_, __frame, 61, 41, function ___(__0, __13) {
        ...
        case "tablevaluedfunction": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listTableValuedFunctions(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 66, 38, function ___(__0, __14) {
                toReturn = __14; __then(); }, true)); } else { return client.catalog.getTableValuedFunction(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, __cb(_, __frame, 69, 41, function ___(__0, __15) {
        ...
        case "tablestatistics": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listTableStatistics(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, __cb(_, __frame, 74, 38, function ___(__0, __16) {
                toReturn = __16; __then(); }, true)); } else { return client.catalog.getTableStatistic(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, catalogItem.tableStatisticsName, __cb(_, __frame, 77, 41, function ___(__0, __17) {
        ...
        case "view": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listViews(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 82, 38, function ___(__0, __18) {
                toReturn = __18; __then(); }, true)); } else { return client.catalog.getView(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, __cb(_, __frame, 85, 41, function ___(__0, __19) {
        ...
        case "procedure": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listProcedures(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 90, 38, function ___(__0, __20) {
                toReturn = __20; __then(); }, true)); } else { return client.catalog.getProcedure(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, __cb(_, __frame, 93, 41, function ___(__0, __21) {
        ...
        case "types": return (function __$getCatalogItem(__then) { if (isList) {
              return client.catalog.listTypes(accountName, catalogItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, __cb(_, __frame, 98, 38, function ___(__0, __22) {
                toReturn = __22; __then(); }, true)); } else { return _(new Error($("U-SQL Types can only be returned in a list of all types within a database and schema combination.")));
  ...
  function listAllDataLakeAnalyticsAccounts(subscription, resourceGroup, _) { var client, accounts, response; var __frame = { name: "listAllDataLakeAnalyticsAccounts", line: 979 }; return __func(_, this, arguments, listAllDataLakeAnalyticsAccounts, 2, __frame, function __$listAllDataLakeAnalyticsAccounts() {
  ...
  function getResrouceGroupByAccountName(subscription, resourceGroup, name, _) { var accounts, i, acctId, rgStart, rgEnd; var __frame = { name: "getResrouceGroupByAccountName", line: 1004 }; return __func(_, this, arguments, getResrouceGroupByAccountName, 3, __frame, function __$getResrouceGroupByAccountName() {
