...
function getPrincipalDetails(principalId, principalDetailsCache, graphClient, _) { var principalDetails, user, group, sp; var __frame = { name: "getPrincipalDetails", line: 225 }; return __func(_, this, arguments, getPrincipalDetails, 3, __frame, function __$getPrincipalDetails() {
    ...
    principalDetails = { }; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getPrincipalDetails() {
          ...
          return graphClient.userOperations.get(principalId, __cb(_, __frame, 9, 38, function ___(__0, __1) { user = __1; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$getPrincipalDetails() { if (ex) {
          ...
          if (user) {
            ...
            principalDetailsCache[principalId] = principalDetails; __then(); } else { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getPrincipalDetails() {
                  ...
                  return graphClient.groupOperations.get(principalId, __cb(_, __frame, 23, 42, function ___(__0, __2) { group = __2; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$getPrincipalDetails() { if (ex) {
                  ...
                  if (group) {
                    ...
                    principalDetailsCache[principalId] = principalDetails; __then(); } else { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getPrincipalDetails() {
                          ...
                          return graphClient.servicePrincipalOperations.get(principalId, __cb(_, __frame, 37, 52, function ___(__0, __3) { sp = __3; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$getPrincipalDetails() { if (ex) {
