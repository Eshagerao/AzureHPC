...
__.extend(VMClient.prototype, {
  createVM: function createVM__1(resourceGroupName, vmName, location, osType, options, _) { var subscription, params, serviceClients, virtualMachine, vmResult, vmProfile, vmCreateProfile, diagProfile, diagMessage, foundBginfoExt, foundMajorVersion, vmImage, publishers, key1, types, key2, versions, key3, versionTable, bgInfoParams, vmExtensionProfile, vmBgInfoExtension, __this = this; var __frame = { name: "createVM__1", line: 57 }; return __func(_, this, arguments, createVM__1, 5, __frame, function __$createVM__1() {
      ...
      return virtualMachine.getVM(resourceGroupName, params.vmName, __cb(_, __frame, 79, 34, function ___(__0, __5) { vmResult = __5;
        if (vmResult) {
        ...
        return vmProfile.generateVMProfile(__cb(_, __frame, 85, 36, function ___(__0, __6) { vmCreateProfile = __6;
          ...
          foundMajorVersion = (vmConstants.EXTENSIONS.BGINFO_MAJOR_VERSION + ".0"); return (function __$createVM__1(__then) {
            if ((!params.disableBginfoExtension && (osType.toString().toLowerCase() == "windows"))) {
              ...
              return vmImage.getVMImagePublisherList(location, __cb(_, __frame, 103, 31, function ___(__0, __7) { publishers = __7;
                var __1 = __forIn(publishers); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$createVM__1() { __more = false; var __13 = (__2 < __1.length); if (__13) { key1 = __1[__2++]; return (function __$createVM__1(__then) {
                        if ((publishers[key1].name === vmConstants.EXTENSIONS.BGINFO_PUBLISHER)) {
                          return vmImage.getVMExtensionImageTypeList(location, publishers[key1].name, __cb(_, __frame, 106, 30, function ___(__0, __8) { types = __8;
                            var __3 = __forIn(types); var __4 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$createVM__1() { __more = false; var __15 = (__4 < __3.length); if (__15) { key2 = __3[__4++]; return (function __$createVM__1(__then) {
                                    if ((types[key2].name === vmConstants.EXTENSIONS.BGINFO_NAME)) {
                                      return vmImage.getVMExtensionImageVersionList(location, publishers[key1].name, types[key2].name, __cb(_, __frame, 109, 37, function ___(__0, __9) { versions = __9;
            ...
            return virtualMachine.createOrUpdateVM(resourceGroupName, vmCreateProfile.profile, true, __cb(_, __frame, 131, 19, function __$createVM__1() { return (function __$createVM__1(__then) {
                ...
                if (foundBginfoExt) {
                  ...
                  return virtualMachine.createOrUpdateVMExtension(resourceGroupName, params.vmName, vmBgInfoExtension.profile, true, __cb(_, __frame, 145, 21, __then, true)); } else { __then(); } ; })(_); }, true)); }); }, true)); }, true)); }); },



  getDefaultVmSize: function getDefaultVmSize__2(location, _) { var subscription, serviceClients, virtualMachine, sizeResult, selectedSize, findAndSet, __this = this; var __frame = { name: "getDefaultVmSize__2", line: 206 }; return __func(_, this, arguments, getDefaultVmSize__2, 1, __frame, function __$getDefaultVmSize__2() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  tryCreatePremiumStorageAccount: function tryCreatePremiumStorageAccount__3(storageManagementClient, location, resourceGroupName, name, _) { var defaultType, createdAccount, stoParams, __this = this; var __frame = { name: "tryCreatePremiumStorageAccount__3", line: 226 }; return __func(_, this, arguments, tryCreatePremiumStorageAccount__3, 4, __frame, function __$tryCreatePremiumStorageAccount__3() {
  ...
  quickCreateVM: function quickCreateVM__4(resourceGroupName, vmName, location, osType, imageUrn, adminUsername, adminPassword, options, _) { var subscription, removeAllSpace, hash, resourceNamePrefix, resourceName, params, serviceClients, response, rgList, found, index, rgParams, virtualMachine, vmResult, vmProfile, vmCreateProfile, __this = this; var __frame = { name: "quickCreateVM__4", line: 252 }; return __func(_, this, arguments, quickCreateVM__4, 8, __frame, function __$quickCreateVM__4() {
      subscription = profile.current.getSubscription(__this.subscription);
      ...
      hash = utils.getHash((((resourceGroupName + vmName) + location) + imageUrn));

      resourceNamePrefix = ((((removeAllSpace(vmName).slice(0, 5) + "-") + removeAllSpace(location).slice(0, 5)) + "-") + hash);
      ...
      params.imageUrn = imageUrn; return (function __$quickCreateVM__4(_) {
        ...
        var __1 = options.vmSize; if (__1) { return _(null, __1); } ; return __this.getDefaultVmSize(location, __cb(_, __frame, 26, 44, _, true)); })(__cb(_, __frame, -251, 17, function ___(__0, __2) { params.vmSize = __2;
        ...
        return serviceClients.resourceManagementClient.resourceGroups.list({ }, __cb(_, __frame, 60, 74, function ___(__0, __3) { response = __3;
          ...
          for (index in rgList) {
            ...
            if ((found === false)) {
              ...
              return serviceClients.resourceManagementClient.resourceGroups.createOrUpdate(resourceGroupName, rgParams, __cb(_, __frame, 71, 61, __then, true)); } else { __then(); } ; })(function __$quickCreateVM__4() {


            virtualMachine = new VirtualMachine(__this.cli, serviceClients);
            return virtualMachine.getVM(resourceGroupName, params.vmName, __cb(_, __frame, 75, 34, function ___(__0, __4) { vmResult = __4;
              if (vmResult) {
                return _(new Error(util.format($("A virtual machine with name \"%s\" already exists in the resource group \"%s\""), vmResult.name, resourceGroupName))); } ;


              vmProfile = new VMProfile(__this.cli, resourceGroupName, params, serviceClients);
              return vmProfile.generateVMProfile(__cb(_, __frame, 81, 36, function ___(__0, __5) { vmCreateProfile = __5;
                return virtualMachine.createOrUpdateVM(resourceGroupName, vmCreateProfile.profile, true, __cb(_, __frame, 82, 19, function __$quickCreateVM__4() {

                  return __this.showVM(resourceGroupName, params.vmName, { }, __cb(_, __frame, 84, 9, function __$quickCreateVM__4() { _(); }, true)); }, true)); }, true)); }, true)); }); }, true)); }, true)); }); },


  showVM: function showVM__5(resourceGroupName, name, options, _) { var output, isJson, depth, subscription, serviceClients, dependencies, vmResult, virtualMachine, __this = this; var __frame = { name: "showVM__5", line: 339 }; return __func(_, this, arguments, showVM__5, 3, __frame, function __$showVM__5() {
  ...
  listVM: function listVM__6(resourceGroupName, options, _) { var subscription, serviceClients, virtualMachine, vmsResult, output, __this = this; var __frame = { name: "listVM__6", line: 386 }; return __func(_, this, arguments, listVM__6, 2, __frame, function __$listVM__6() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  deleteVM: function deleteVM__7(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "deleteVM__7", line: 409 }; return __func(_, this, arguments, deleteVM__7, 3, __frame, function __$deleteVM__7() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __2) { vmResult = __2;
        if (!vmResult) {
          return _(new Error(util.format($("Virtual machine \"%s\" not found under the resource group \"%s\""), name, resourceGroupName))); } ; return (function __$deleteVM__7(_) {


          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm(util.format($("Delete the virtual machine \"%s\"? [y/n] "), name), __cb(_, __frame, 10, 48, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -408, 17, function ___(__0, __3) { return (function __$deleteVM__7(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteVM__7() {



            return virtualMachine.deleteVM(resourceGroupName, name, __cb(_, __frame, 14, 19, function __$deleteVM__7() { _(); }, true)); }); }, true)); }, true)); }); },


  stopVM: function stopVM__8(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "stopVM__8", line: 426 }; return __func(_, this, arguments, stopVM__8, 3, __frame, function __$stopVM__8() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.stopVM(resourceGroupName, name, __cb(_, __frame, 13, 19, function __$stopVM__8() { _(); }, true)); }, true)); }); },


  restartVM: function restartVM__9(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "restartVM__9", line: 442 }; return __func(_, this, arguments, restartVM__9, 3, __frame, function __$restartVM__9() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.restartVM(resourceGroupName, name, __cb(_, __frame, 10, 19, function __$restartVM__9() { _(); }, true)); }, true)); }); },


  startVM: function startVM__10(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "startVM__10", line: 455 }; return __func(_, this, arguments, startVM__10, 3, __frame, function __$startVM__10() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.startVM(resourceGroupName, name, __cb(_, __frame, 10, 19, function __$startVM__10() { _(); }, true)); }, true)); }); },


  deallocateVM: function deallocateVM__11(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "deallocateVM__11", line: 468 }; return __func(_, this, arguments, deallocateVM__11, 3, __frame, function __$deallocateVM__11() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.deallocateVM(resourceGroupName, name, __cb(_, __frame, 10, 19, function __$deallocateVM__11() { _(); }, true)); }, true)); }); },


  captureVM: function captureVM__12(resourceGroupName, name, vhdNamePrefix, options, _) { var subscription, serviceClients, virtualMachine, vmResult, result, __this = this; var __frame = { name: "captureVM__12", line: 481 }; return __func(_, this, arguments, captureVM__12, 4, __frame, function __$captureVM__12() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  generalizeVM: function generalizeVM__13(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "generalizeVM__13", line: 509 }; return __func(_, this, arguments, generalizeVM__13, 3, __frame, function __$generalizeVM__13() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.generalizeVM(resourceGroupName, name, __cb(_, __frame, 10, 19, function __$generalizeVM__13() { _(); }, true)); }, true)); }); },


  getInstanceView: function getInstanceView__14(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, output, instanceViewResult, vmInstanceView, __this = this; var __frame = { name: "getInstanceView__14", line: 522 }; return __func(_, this, arguments, getInstanceView__14, 3, __frame, function __$getInstanceView__14() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      output = __this.cli.output;
  ...
  getSerialOutput: function getSerialOutput__15(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, output, instanceViewResult, vmResult, instanceView, consoleScreenshotBlobUri, serialConsoleLogBlobUri, result, storageClient, keys, blobService, content, ws, performStorageOperation, operation, storageOptions, maxLen, startPos, strlen, __this = this; var __frame = { name: "getSerialOutput__15", line: 543 }; return __func(_, this, arguments, getSerialOutput__15, 3, __frame, function __$getSerialOutput__15() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      output = __this.cli.output;

      return virtualMachine.getInstanceView(resourceGroupName, name, __cb(_, __frame, 6, 44, function ___(__0, __2) { instanceViewResult = __2; return (function __$getSerialOutput__15(__then) {
          if (!instanceViewResult) {
            if (output.format().json) {
              output.json({ }); }
             else {
            ...
            vmResult = instanceViewResult; return (function __$getSerialOutput__15(__then) {
              if (vmResult) {
                ...
                if (((instanceView && instanceView.bootDiagnostics) && instanceView.bootDiagnostics.consoleScreenshotBlobUri)) {
                  ...
                  __this.cli.output.info(util.format($("Console Screenshot Blob Uri:\n%s"), consoleScreenshotBlobUri)); } ; return (function __$getSerialOutput__15(__then) {
                  ...
                  if (((instanceView && instanceView.bootDiagnostics) && instanceView.bootDiagnostics.serialConsoleLogBlobUri)) {
                    ...
                    result = __this._getStorageAccountContainerAndBlobFromUri(serialConsoleLogBlobUri); return (function __$getSerialOutput__15(__then) {
                      if (((result.accountName && result.containerName) && result.blobName)) {
                        ...
                        return storageClient.storageAccounts.listKeys(resourceGroupName, result.accountName, __cb(_, __frame, 34, 53, function ___(__0, __3) { keys = __3;
                          ...
                          storageOptions = __this._getStorageBlobOperationDefaultOption(); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getSerialOutput__15() {


                                return performStorageOperation(operation, __cb(_, __frame, 50, 14, __then, true), result.containerName, result.blobName, ws, storageOptions); }); })(function ___(e, __result) { __catch(function __$getSerialOutput__15() { if (e) {
                                  ...
                                  if (StorageUtil.isNotFoundException(e)) {
                                    ...
                                    return _(e); } ; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$getSerialOutput__15() {



                              maxLen = ((options.maxLength === null) ? 1000000 : parseInt(options.maxLength, 10));
                              startPos = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$getSerialOutput__15() { __more = false;
                                  var __8 = (startPos < content.length); if (__8) { return (function __$getSerialOutput__15(_) {
                                      var __1 = (startPos > 0); if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm("Do you want to view more log?", __cb(_, __frame, 64, 56, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -542, 17, function ___(__0, __4) { return (function __$getSerialOutput__15(__then) { if (__4) { return __break(); } else { __then(); } ; })(function __$getSerialOutput__15() {
  ...
  resetVMAccess: function resetVMAccess__16(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, vmExtensionProfile, vmAccessExtension, __this = this; var __frame = { name: "resetVMAccess__16", line: 621 }; return __func(_, this, arguments, resetVMAccess__16, 3, __frame, function __$resetVMAccess__16() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, vmAccessExtension.profile, true, __cb(_, __frame, 16, 19, function __$resetVMAccess__16() { _(); }, true)); }, true)); }); },


  enableDiagVM: function enableDiagVM__17(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, diagParams, vmExtensionProfile, vmDiagExtension, __this = this; var __frame = { name: "enableDiagVM__17", line: 640 }; return __func(_, this, arguments, enableDiagVM__17, 3, __frame, function __$enableDiagVM__17() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return vmExtensionProfile.generateVMDiagExtensionProfile(__cb(_, __frame, 22, 45, function ___(__0, __2) { vmDiagExtension = __2;
          return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, vmDiagExtension.profile, true, __cb(_, __frame, 23, 19, function __$enableDiagVM__17() { _(); }, true)); }, true)); }, true)); }); },


  enableAemVM: function enableAemVM__18(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, aemExtensionUtil, vmResult, vmStorageAccounts, saProperties, storageAccountsResult, osDiskUri, i, dataDisk, dataDiskUri, vmStorageAccountNames, diagExtension, wadStorageAccountName, diagParams, progress, vmDiagExtensionProfile, aemParams, vmAEMExtensionProfile, vmAEMExtension, __this = this; var __frame = { name: "enableAemVM__18", line: 666 }; return __func(_, this, arguments, enableAemVM__18, 3, __frame, function __$enableAemVM__18() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 6, 34, function ___(__0, __2) { vmResult = __2;
        ...
        storageAccountsResult = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$enableAemVM__18() {

              return serviceClients.storageManagementClient.storageAccounts.list(__cb(_, __frame, 20, 85, function ___(__0, __3) { storageAccountsResult = __3; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$enableAemVM__18() {

                StorageUtil.endProgress(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$enableAemVM__18() {
            ...
            return aemExtensionUtil.getStorageAccountProperties(serviceClients, storageAccountsResult, osDiskUri.accountName, __cb(_, __frame, 26, 36, function ___(__0, __4) { saProperties = __4;
              ...
              i = 0; var __13 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$enableAemVM__18() { __more = false; if (__13) { i++; } else { __13 = true; } ; var __12 = (i < vmResult.storageProfile.dataDisks.length); if (__12) {
                    dataDisk = vmResult.storageProfile.dataDisks[i];
                    dataDiskUri = blobUtil.splitDestinationUri(dataDisk.vhd.uri); return (function __$enableAemVM__18(__then) {
                      if (!vmStorageAccounts[dataDiskUri.accountName]) {
                        return aemExtensionUtil.getStorageAccountProperties(serviceClients, storageAccountsResult, dataDiskUri.accountName, __cb(_, __frame, 34, 40, function ___(__0, __5) { saProperties = __5;
                          vmStorageAccounts[saProperties.name] = saProperties; __then(); }, true)); } else { __then(); } ; })(function __$enableAemVM__18() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$enableAemVM__18() {




                vmStorageAccountNames = Object.keys(vmStorageAccounts);
                i = 0; var __16 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$enableAemVM__18() { __more = false; if (__16) { i++; } else { __16 = true; } ; var __15 = (i < vmStorageAccountNames.length); if (__15) {
                      vmStorageAccount = vmStorageAccounts[vmStorageAccountNames[i]]; return (function __$enableAemVM__18(__then) {
                        if ((vmStorageAccount.type === "Standard")) {
                          return aemExtensionUtil.enableStorageAccountAnalytics(vmStorageAccount, __cb(_, __frame, 44, 25, __then, true)); } else { __then(); } ; })(function __$enableAemVM__18() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$enableAemVM__18() {
                  ...
                  wadStorageAccountName = null; return (function __$enableAemVM__18(__then) {
                    if (!diagExtension) {
                      __this.cli.output.info(util.format($("Diagnostic extension must be enabled first for Virtual Machine \"%s\"."), name)); return (function __$enableAemVM__18(_) {
                        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm($("Install the virtual machine diagnostic extension? [y/n] "), __cb(_, __frame, 61, 50, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -665, 17, function ___(__0, __6) { return (function __$enableAemVM__18(__then) { if (__6) {
                            __this.cli.output.error($("Canceled. Please enable diagnostic extension first.")); return _(null); } else { __then(); } ; })(function __$enableAemVM__18() {
                          ...
                          progress = __this.cli.interaction.progress($("Preparing parameters for diagnostic extension")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$enableAemVM__18() {

                                vmDiagExtensionProfile = new VMExtensionProfile(__this.cli, diagParams, serviceClients);
                                return vmDiagExtensionProfile.generateVMDiagExtensionProfile(__cb(_, __frame, 95, 47, function ___(__0, __7) { diagExtension = __7.profile; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$enableAemVM__18() {

                                  progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$enableAemVM__18() {
                      ...
                      if (!wadStorageAccountName) {
                        ...
                        if (!wadStorageAccountName) {
                          ...
                          __this.cli.output.error($("Please specify one with option -a, --diagnostic-storage-account-name")); return _(null); } ; } ; __then(); } ; })(function __$enableAemVM__18() { return (function __$enableAemVM__18(__then) {
                      ...
                      if (!vmStorageAccounts[wadStorageAccountName]) {
                        return aemExtensionUtil.getStorageAccountProperties(serviceClients, storageAccountsResult, wadStorageAccountName, __cb(_, __frame, 115, 38, function ___(__0, __8) { saProperties = __8;
                          vmStorageAccounts[saProperties.name] = saProperties; __then(); }, true)); } else { __then(); } ; })(function __$enableAemVM__18() {
                      ...
                      return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, vmAEMExtension.profile, true, __cb(_, __frame, 133, 19, function __$enableAemVM__18() { _(); }, true)); }); }); }); }); }, true)); }); }); }, true)); }); },


  setVM: function setVM__19(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, vmProfile, __this = this; var __frame = { name: "setVM__19", line: 802 }; return __func(_, this, arguments, setVM__19, 3, __frame, function __$setVM__19() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return vmProfile.updateVMProfile(vmResult, __cb(_, __frame, 24, 25, function ___(__0, __2) { vmResult = __2;
          ...
          return virtualMachine.createOrUpdateVM(resourceGroupName, vmResult, false, __cb(_, __frame, 26, 19, function __$setVM__19() { _(); }, true)); }, true)); }, true)); }); },


  listVMSizesOrLocationVMSizes: function listVMSizesOrLocationVMSizes__20(options, _) { var subscription, serviceClients, virtualMachine, sizeResult, vmResult, output, __this = this; var __frame = { name: "listVMSizesOrLocationVMSizes__20", line: 831 }; return __func(_, this, arguments, listVMSizesOrLocationVMSizes__20, 1, __frame, function __$listVMSizesOrLocationVMSizes__20() {
      if ((options.location && options.vmName)) {
        return _(new Error($("Both --location and --vm-name parameters cannot be specified together."))); } ; return (function __$listVMSizesOrLocationVMSizes__20(__then) {


        if (options.vmName) { return (function __$listVMSizesOrLocationVMSizes__20(__then) {
          ...
          if (!options.location) {
            return _(new Error($("One of the optional parameter --location or --vm-name is required."))); } ; __then(); } ; })(function __$listVMSizesOrLocationVMSizes__20() {


        subscription = profile.current.getSubscription(__this.subscription);
        serviceClients = __this._getServiceClients(subscription);
        virtualMachine = new VirtualMachine(__this.cli, serviceClients); return (function __$listVMSizesOrLocationVMSizes__20(__then) {
          ...
          if (options.vmName) {
            ...
            return virtualMachine.getVMSizesByLocationName(options.location, __cb(_, __frame, 26, 34, function ___(__0, __4) { sizeResult = __4; __then(); }, true)); } ; })(function __$listVMSizesOrLocationVMSizes__20() {
  ...
  listComputeUsage: function listComputeUsage__21(location, options, _) { var subscription, client, usageResult, output, usages, __this = this; var __frame = { name: "listComputeUsage__21", line: 877 }; return __func(_, this, arguments, listComputeUsage__21, 2, __frame, function __$listComputeUsage__21() {
      subscription = profile.current.getSubscription(__this.subscription);
  ...
  attachNewDataDisk: function attachNewDataDisk__22(resourceGroup, vmName, size, vhdName, options, _) { var subscription, serviceClients, params, virtualMachine, vmResult, vmStorageProfile, newDataDisk, dataDisks, __this = this; var __frame = { name: "attachNewDataDisk__22", line: 904 }; return __func(_, this, arguments, attachNewDataDisk__22, 5, __frame, function __$attachNewDataDisk__22() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return virtualMachine.getVM(resourceGroup, vmName, __cb(_, __frame, 15, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return vmStorageProfile.generateDataDiskProfile(__cb(_, __frame, 28, 39, function ___(__0, __2) { newDataDisk = __2;
          ...
          dataDisks = (vmResult.storageProfile.dataDisks || []);
          dataDisks.push(newDataDisk); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$attachNewDataDisk__22() {


                return virtualMachine.createOrUpdateVM(resourceGroup, vmResult, false, __cb(_, __frame, 35, 21, __then, true)); }); })(function ___(err, __result) { __catch(function __$attachNewDataDisk__22() { if (err) {
                  ...
                  if (((err.code === "InvalidParameter") && (err.message === "The value of parameter 'dataDisk.lun' is invalid."))) {
                    ...
                    return _(err); } ; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$attachNewDataDisk__22() { _(); }); }); }, true)); }, true)); }); },




  attachDataDisk: function attachDataDisk__23(resourceGroup, vmName, vhdUrl, options, _) { var subscription, serviceClients, params, virtualMachine, vmResult, vmStorageProfile, newDataDisk, dataDisks, __this = this; var __frame = { name: "attachDataDisk__23", line: 949 }; return __func(_, this, arguments, attachDataDisk__23, 4, __frame, function __$attachDataDisk__23() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return virtualMachine.getVM(resourceGroup, vmName, __cb(_, __frame, 12, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return vmStorageProfile.generateDataDiskProfile(__cb(_, __frame, 19, 39, function ___(__0, __2) { newDataDisk = __2;
          ...
          dataDisks = (vmResult.storageProfile.dataDisks || []);
          dataDisks.push(newDataDisk); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$attachDataDisk__23() {


                return virtualMachine.createOrUpdateVM(resourceGroup, vmResult, false, __cb(_, __frame, 25, 21, __then, true)); }); })(function ___(err, __result) { __catch(function __$attachDataDisk__23() { if (err) {

                  if (((err.code === "InvalidParameter") && (err.message === "The value of parameter 'dataDisk.lun' is invalid."))) {
                    return _(new Error(util.format($("Exceeded the maximum number of data disks that can be attached to a VM with size \"%s\"."), vmResult.hardwareProfile.vmSize))); }
                   else {
                    return _(err); } ; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$attachDataDisk__23() { _(); }); }); }, true)); }, true)); }); },




  detachDataDisk: function detachDataDisk__24(resourceGroup, vmName, lun, options, _) { var subscription, serviceClients, lunAsInt, virtualMachine, vmResult, vmStorageProfile, __this = this; var __frame = { name: "detachDataDisk__24", line: 984 }; return __func(_, this, arguments, detachDataDisk__24, 4, __frame, function __$detachDataDisk__24() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return virtualMachine.getVM(resourceGroup, vmName, __cb(_, __frame, 10, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.createOrUpdateVM(resourceGroup, vmResult, false, __cb(_, __frame, 18, 19, function __$detachDataDisk__24() { _(); }, true)); }, true)); }); },


  listDataDisks: function listDataDisks__25(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, dataDisks, output, __this = this; var __frame = { name: "listDataDisks__25", line: 1005 }; return __func(_, this, arguments, listDataDisks__25, 3, __frame, function __$listDataDisks__25() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  setExtension: function setExtension__26(resourceGroupName, vmName, extensionName, publisherName, version, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "setExtension__26", line: 1038 }; return __func(_, this, arguments, setExtension__26, 6, __frame, function __$setExtension__26() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.getVM(resourceGroupName, vmName, __cb(_, __frame, 4, 34, function ___(__0, __1) { vmResult = __1;
        ...
        if ((virtualMachine.storageProfile.osDisk.osType === "Windows")) {
          if ((!virtualMachine.osProfile.windowsConfiguration || !virtualMachine.osProfile.windowsConfiguration.provisionVMAgent)) {
            return _(new Error($("Provision Guest Agent must be enabled on the VM before setting VM Extension."))); } ; } ; return (function __$setExtension__26(__then) {



          if (options.uninstall) {
            return __this._uninstallExtension(resourceGroupName, vmName, extensionName, serviceClients, options, __cb(_, __frame, 17, 11, function __$setExtension__26() { return _(null); }, true)); } else { __then(); } ; })(function __$setExtension__26() {



          options.location = vmResult.location;
          return __this._createOrUpdateExtension(resourceGroupName, vmName, extensionName, publisherName, version, options, serviceClients, __cb(_, __frame, 22, 9, function __$setExtension__26() { _(); }, true)); }); }, true)); }); },


  setChefExtension: function setChefExtension__27(resourceGroupName, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, extensionName, vmImage, versionsResult, versions, ver, __this = this; var __frame = { name: "setChefExtension__27", line: 1063 }; return __func(_, this, arguments, setChefExtension__27, 3, __frame, function __$setChefExtension__27() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription); return (function __$setChefExtension__27(__then) {

        if ((!options.clientPem && !options.validationPem)) {
          return __this.cli.interaction.promptIfNotGiven($("VM Extension validation pem file path: "), options.validationPem, __cb(_, __frame, 5, 51, function ___(__0, __1) { options.validationPem = __1; __then(); }, true)); } else { __then(); } ; })(function __$setChefExtension__27() { return (function __$setChefExtension__27(__then) {


          if (!options.clientConfig) {
            return __this.cli.interaction.promptIfNotGiven($("Chef client config file(i.e client.rb) path: "), options.clientConfig, __cb(_, __frame, 9, 50, function ___(__0, __2) { options.clientConfig = __2; __then(); }, true)); } else { __then(); } ; })(function __$setChefExtension__27() {
          ...
          return virtualMachine.getVM(resourceGroupName, vmName, __cb(_, __frame, 13, 34, function ___(__0, __3) { vmResult = __3;
            ...
            if ((virtualMachine.storageProfile.osDisk.osType === "Windows")) {
              ...
              extensionName = "LinuxChefClient"; } ; return (function __$setChefExtension__27(__then) {


              if (options.uninstall) {
                return __this._uninstallExtension(resourceGroupName, vmName, extensionName, serviceClients, options, __cb(_, __frame, 33, 11, function __$setChefExtension__27() { return _(null); }, true)); } else { __then(); } ; })(function __$setChefExtension__27() { return (function __$setChefExtension__27(__then) {
                ...
                if (!options.version) {
                  ...
                  return vmImage.getVMExtensionImageVersionList(options.location, CHEFPUBLISHER, extensionName, __cb(_, __frame, 40, 35, function ___(__0, __4) { versionsResult = __4;
                    ...
                    options.version = ((ver[0] + ".") + ver[1]); __then(); }, true)); } else { __then(); } ; })(function __$setChefExtension__27() {
                ...
                pubConfig["deleteChefConfig"] = (options.deleteChefConfig ? "true" : "false"); return (function __$setChefExtension__27(__then) {
                  if (options.bootstrapOptions) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$setChefExtension__27() {

                          pubConfig["bootstrap_options"] = JSON.parse(options.bootstrapOptions); __then(); }); })(function ___(er, __result) { __catch(function __$setChefExtension__27() { if (er) {

                            log.error("Bad user input for -j or --bootstrap-options option", er);
                            return _(null, cb(er)); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(function __$setChefExtension__27() {
                  ...
                  return __this._createOrUpdateExtension(resourceGroupName, vmName, extensionName, CHEFPUBLISHER, options.version, options, serviceClients, __cb(_, __frame, 72, 9, function __$setChefExtension__27() { _(); }, true)); }); }); }); }, true)); }); }); }); },



  getExtensions: function getExtensions__28(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "getExtensions__28", line: 1139 }; return __func(_, this, arguments, getExtensions__28, 3, __frame, function __$getExtensions__28() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  getChefExtension: function getChefExtension__29(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "getChefExtension__29", line: 1170 }; return __func(_, this, arguments, getChefExtension__29, 3, __frame, function __$getChefExtension__29() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  createDockerVM: function createDockerVM__30(resourceGroupName, vmName, location, osType, options, _) { var subscription, serviceClients, dockerExtensionParams, vmExtensionProfile, dockerExtension, virtualMachine, __this = this; var __frame = { name: "createDockerVM__30", line: 1205 }; return __func(_, this, arguments, createDockerVM__30, 5, __frame, function __$createDockerVM__30() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return vmExtensionProfile.generateDockerExtensionProfile(__cb(_, __frame, 13, 45, function ___(__0, __1) { dockerExtension = __1;
        ...
        return __this.createVM(resourceGroupName, vmName, location, osType, options, __cb(_, __frame, 15, 9, function __$createDockerVM__30() {
          virtualMachine = new VirtualMachine(__this.cli, serviceClients); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createDockerVM__30() {

                return virtualMachine.createOrUpdateVMExtension(resourceGroupName, vmName, dockerExtension.profile, true, __cb(_, __frame, 18, 21, __then, true)); }); })(function ___(e, __result) { __catch(function __$createDockerVM__30() { if (e) {

                  return virtualMachine.deleteVM(resourceGroupName, vmName, __cb(_, __frame, 20, 21, function __$createDockerVM__30() {
                    return _(e); }, true)); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$createDockerVM__30() { _(); }); }); }, true)); }, true)); }); },



  listVMImagePublishers: function listVMImagePublishers__31(location, options, _) { var subscription, serviceClients, vmImage, publishersResult, publishers, output, __this = this; var __frame = { name: "listVMImagePublishers__31", line: 1230 }; return __func(_, this, arguments, listVMImagePublishers__31, 2, __frame, function __$listVMImagePublishers__31() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImageOffers: function listVMImageOffers__32(location, publisherName, options, _) { var subscription, serviceClients, vmImage, offersResult, offers, output, __this = this; var __frame = { name: "listVMImageOffers__32", line: 1257 }; return __func(_, this, arguments, listVMImageOffers__32, 3, __frame, function __$listVMImageOffers__32() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImageSkus: function listVMImageSkus__33(location, publisherName, offer, options, _) { var subscription, serviceClients, vmImage, skuResult, skus, output, __this = this; var __frame = { name: "listVMImageSkus__33", line: 1285 }; return __func(_, this, arguments, listVMImageSkus__33, 4, __frame, function __$listVMImageSkus__33() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImages: function listVMImages__34(params, options, _) { var subscription, serviceClients, imageFilter, vmImage, imagesResult, images, output, __this = this; var __frame = { name: "listVMImages__34", line: 1314 }; return __func(_, this, arguments, listVMImages__34, 2, __frame, function __$listVMImages__34() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      imageFilter = {
  ...
  getVMImageDetails: function getVMImageDetails__35(params, options, _) { var subscription, serviceClients, imageFilter, vmImage, imagesResult, images, output, __this = this; var __frame = { name: "getVMImageDetails__35", line: 1351 }; return __func(_, this, arguments, getVMImageDetails__35, 2, __frame, function __$getVMImageDetails__35() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      imageFilter = {
        location: params.location,
  ...
  listVMExtensionImageTypes: function listVMExtensionImageTypes__36(location, publisherName, options, _) { var subscription, serviceClients, vmImage, typesResult, types, output, __this = this; var __frame = { name: "listVMExtensionImageTypes__36", line: 1392 }; return __func(_, this, arguments, listVMExtensionImageTypes__36, 3, __frame, function __$listVMExtensionImageTypes__36() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMExtensionImageVersions: function listVMExtensionImageVersions__37(location, publisherName, typeName, options, _) { var subscription, serviceClients, vmImage, versionsResult, versions, output, __this = this; var __frame = { name: "listVMExtensionImageVersions__37", line: 1420 }; return __func(_, this, arguments, listVMExtensionImageVersions__37, 4, __frame, function __$listVMExtensionImageVersions__37() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMExtensionImages: function listVMExtensionImages__38(location, publisher, typeName, options, _) { var subscription, serviceClients, vmImageClient, extImagesResult, extImages, output, __this = this; var __frame = { name: "listVMExtensionImages__38", line: 1449 }; return __func(_, this, arguments, listVMExtensionImages__38, 4, __frame, function __$listVMExtensionImages__38() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  getVMExtensionImage: function getVMExtensionImage__39(location, publisherName, typeName, version, options, _) { var subscription, serviceClients, vmImage, imageResult, output, __this = this; var __frame = { name: "getVMExtensionImage__39", line: 1477 }; return __func(_, this, arguments, getVMExtensionImage__39, 5, __frame, function __$getVMExtensionImage__39() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  _createOrUpdateExtension: function _createOrUpdateExtension__40(resourceGroupName, vmName, extensionName, publisherName, version, options, serviceClients, _) { var vMExtensionProfile, vmExtension, virtualMachine, __this = this; var __frame = { name: "_createOrUpdateExtension__40", line: 1499 }; return __func(_, this, arguments, _createOrUpdateExtension__40, 7, __frame, function __$_createOrUpdateExtension__40() {
      ...
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.createOrUpdateVMExtension(resourceGroupName, vmName, vmExtension.profile, true, __cb(_, __frame, 9, 19, function __$_createOrUpdateExtension__40() { _(); }, true)); }); },


  _uninstallExtension: function _uninstallExtension__41(resourceGroupName, vmName, extensionName, serviceClients, options, _) { var virtualMachine, extension, __this = this; var __frame = { name: "_uninstallExtension__41", line: 1511 }; return __func(_, this, arguments, _uninstallExtension__41, 5, __frame, function __$_uninstallExtension__41() {
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.getVMExtension(resourceGroupName, vmName, extensionName, __cb(_, __frame, 2, 35, function ___(__0, __2) { extension = __2;
        if (!extension) {
          return _(new Error(util.format($("Extension \"%s\" not found under the virtual machine \"%s\""), extensionName, vmName))); } ; return (function __$_uninstallExtension__41(_) {


          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm(util.format($("Uninstall the virtual machine extension \"%s\"? [y/n] "), extensionName), __cb(_, __frame, 7, 48, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -1510, 17, function ___(__0, __3) { return (function __$_uninstallExtension__41(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$_uninstallExtension__41() {



            return virtualMachine.deleteVMExtension(resourceGroupName, vmName, extensionName, __cb(_, __frame, 11, 19, function __$_uninstallExtension__41() { _(); }, true)); }); }, true)); }, true)); }); },


  _populateNics: function _populateNics__42(virtualMachine, subscription, _) { var networkInterfaces, networkResourceProviderClient, networkNic, networkPublicIP, i, networkInterface, nicInfo, ipConfigurations, ipConfiguration, pubIPInfo, __this = this; var __frame = { name: "_populateNics__42", line: 1525 }; return __func(_, this, arguments, _populateNics__42, 2, __frame, function __$_populateNics__42() {
      ...
      networkInterfaces = virtualMachine.networkProfile.networkInterfaces; return (function __$_populateNics__42(__then) {
        if ((networkInterfaces.length > 0)) {
          ...
          i = 0; var __4 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$_populateNics__42() { __more = false; if (__4) { i++; } else { __4 = true; } ; var __3 = (i < networkInterfaces.length); if (__3) {
                networkInterface = networkInterfaces[i];
                return networkNic.getNICInfoById(networkInterface.id, __cb(_, __frame, 12, 33, function ___(__0, __1) { nicInfo = __1; return (function __$_populateNics__42(__then) {
                    if (nicInfo.profile) {
                      networkInterface.expanded = nicInfo.profile;
                      ipConfigurations = networkInterface.expanded.ipConfigurations; return (function __$_populateNics__42(__then) {
                        if ((ipConfigurations && (ipConfigurations.length > 0))) {

                          ipConfiguration = ipConfigurations[0]; return (function __$_populateNics__42(__then) {
                            if ((ipConfiguration.publicIPAddress && ipConfiguration.publicIPAddress.id)) {
                              return networkPublicIP.getPublicIPInfoById(ipConfiguration.publicIPAddress.id, __cb(_, __frame, 20, 46, function ___(__0, __2) { pubIPInfo = __2;
                                if (pubIPInfo.profile) {
                                  ipConfiguration.publicIPAddress.expanded = pubIPInfo.profile; } ; __then(); }, true)); } else { __then(); } ; })(__then); } else { __then(); } ; })(__then); } else { __then(); } ; })(function __$_populateNics__42() { while (__more) { __loop(); }; __more = true; }); }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(__then); } else { __then(); } ; })(function __$_populateNics__42() {
  ...
  createVMBackup: function createVMBackup__43(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, storageBlobUris, dataDisks, storageSASBlobUris, i, blobUri, result, storageClient, keys, blobService, startDate, expiryDate, sharedAccessPolicy, queryString, uri, params, commandStartTimeUTCTicks, taskId, tag, vmBackupPublicConfig, vmExtensionProfile, azureVmBackupExtension, extResult, __this = this; var __frame = { name: "createVMBackup__43", line: 1617 }; return __func(_, this, arguments, createVMBackup__43, 3, __frame, function __$createVMBackup__43() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __3) { vmResult = __3;
        ...
        storageSASBlobUris = [];
        var __1 = __forIn(storageBlobUris); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$createVMBackup__43() { __more = false; var __7 = (__2 < __1.length); if (__7) { i = __1[__2++];
              blobUri = storageBlobUris[i];
              result = __this._getStorageAccountContainerAndBlobFromUri(blobUri); return (function __$createVMBackup__43(__then) {
                if (((result.accountName && result.containerName) && result.blobName)) {
                  storageClient = serviceClients.storageManagementClient;
                  ...
                  return _(new Error(util.format($("wrong blob uri found %s "), blobUri))); } ; })(function __$createVMBackup__43() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$createVMBackup__43() {
  ...
  removeVMBackup: function removeVMBackup__44(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, storageBlobUris, dataDisks, i, blobUri, result, storageClient, keys, blobService, operation, storageOptions, blobs, tips, performStorageOperation, j, len, __this = this; var __frame = { name: "removeVMBackup__44", line: 1697 }; return __func(_, this, arguments, removeVMBackup__44, 3, __frame, function __$removeVMBackup__44() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 6, 34, function ___(__0, __3) { vmResult = __3;
        ...
        StorageUtil.init(__this.cli);
        var __1 = __forIn(storageBlobUris); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$removeVMBackup__44() { __more = false; var __7 = (__2 < __1.length); if (__7) { i = __1[__2++];
              blobUri = storageBlobUris[i];
              result = __this._getStorageAccountContainerAndBlobFromUri(blobUri); return (function __$removeVMBackup__44(__then) {
                if (((result.accountName && result.containerName) && result.blobName)) {
                  storageClient = serviceClients.storageManagementClient;
                  return storageClient.storageAccounts.listKeys(resourceGroupName, result.accountName, __cb(_, __frame, 23, 53, function ___(__0, __4) { keys = __4;
                    ...
                    startProgress(tips);
                    performStorageOperation = StorageUtil.performStorageOperation; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$removeVMBackup__44() {

                          return performStorageOperation(operation, __cb(_, __frame, 38, 24, function ___(__0, __5) { blobs = __5; _(null, null, true); }, true), result.containerName, storageOptions); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$removeVMBackup__44() {

                            endProgress(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$removeVMBackup__44() {

                        j = 0; len = blobs.length; var __11 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$removeVMBackup__44() { __more = false; if (__11) { j++; } else { __11 = true; } ; var __10 = (j < len); if (__10) {
                              blob = blobs[j]; return (function __$removeVMBackup__44(__then) {
                                if ((blob.metadata["vmbackuptag"] == options.identity)) {
                                  ...
                                  startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$removeVMBackup__44() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$removeVMBackup__44() {

                                              return performStorageOperation(operation, __cb(_, __frame, 52, 24, __then, true), result.containerName, blob.name, storageOptions); }); })(function ___(e, __result) { __catch(function __$removeVMBackup__44() { if (e) {

                                                if (StorageUtil.isNotFoundException(e)) {
                                                  return _(new Error(util.format($("Can not remove blob snapshot '%s' in container '%s'"), blob.name, result.containerName))); }
                                                 else {
                                                  return _(e); } ; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$removeVMBackup__44() { _(null, null, true); }); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$removeVMBackup__44() {


                                          endProgress(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(function __$removeVMBackup__44() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(__then); }); }); }, true)); } else {




                  return _(new Error(util.format($("wrong blob uri found %s "), blobUri))); } ; })(function __$removeVMBackup__44() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(_); }, true)); }); },




  setAzureDiskEncryption: function setAzureDiskEncryption__45(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, params, vmResult, createResult, vmExtensionProfile, azureDiskEncryptionExtension, result, extensionName, publisherName, getOptions, extensionResult, statusUrl, vmModel, encryptionSettings, __this = this; var __frame = { name: "setAzureDiskEncryption__45", line: 1767 }; return __func(_, this, arguments, setAzureDiskEncryption__45, 3, __frame, function __$setAzureDiskEncryption__45() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      params = { };
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 6, 34, function ___(__0, __2) { vmResult = __2;
        if (!vmResult) {
          return _(new Error(util.format($("Virtual machine \"%s\" not found under the resource group \"%s\""), name, resourceGroupName))); } ; return (function __$setAzureDiskEncryption__45(__then) {


          if (utils.ignoreCaseEquals(vmResult.storageProfile.osDisk.osType, "Linux")) {
            return __this.createVMBackup(resourceGroupName, name, options, __cb(_, __frame, 12, 32, function ___(__0, __3) { createResult = __3;
              if (!createResult) {
                return _(new Error($("create backup failed."))); } ; __then(); }, true)); } else { __then(); } ; })(function __$setAzureDiskEncryption__45() {



          if (!utils.ignoreCaseEquals(vmResult.storageProfile.osDisk.osType, "Linux")) {
            if (options.passphrase) {
              return _(new Error($("only Linux support the passphrase specified in parameters."))); } ; }
          ...
          if ((utils.ignoreCaseEquals(params.osType, "Linux") && !utils.ignoreCaseEquals(params.volumeType, "Data"))) {
            ...
            return _(new Error($("Enabling encryption is only allowed on Data volumes for Linux VMs."))); } ;



          vmExtensionProfile = new VMExtensionProfile(__this.cli, params);
          azureDiskEncryptionExtension = vmExtensionProfile.generateAzureDiskEncryptionExtensionProfile(); return (function __$setAzureDiskEncryption__45(_) {

            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ;
            return __this.cli.interaction.confirm($("This cmdlet prepares the VM and enables encryption which may reboot the machine and takes 10-15 minutes to finish. Please save your work on the VM before confirming. Do you want to continue? [y/n] "), __cb(_, __frame, 58, 30, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -1766, 17, function ___(__0, __4) { return (function __$setAzureDiskEncryption__45(__then) { if (__4) { return _(null); } else { __then(); } ; })(function __$setAzureDiskEncryption__45() {




              return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, azureDiskEncryptionExtension.profile, true, __cb(_, __frame, 63, 32, function ___(__0, __5) { result = __5;
                ...
                return serviceClients.computeManagementClient.virtualMachineExtensions.get(resourceGroupName, name, extensionName, getOptions, __cb(_, __frame, 84, 90, function ___(__0, __6) { extensionResult = __6;
                  ...
                  return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 103, 33, function ___(__0, __7) { vmModel = __7;
                    ...
                    return virtualMachine.createOrUpdateVM(resourceGroupName, vmModel, false, __cb(_, __frame, 132, 26, _, true)); }, true)); }, true)); }, true)); }); }, true)); }); }, true)); }); },


  showAzureDiskEncryptionStatus: function showAzureDiskEncryptionStatus__46(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, output, encryptionStatus, extensionStatus, vmModel, extensionName, publisherName, getOptions, isJson, string, __this = this; var __frame = { name: "showAzureDiskEncryptionStatus__46", line: 1902 }; return __func(_, this, arguments, showAzureDiskEncryptionStatus__46, 3, __frame, function __$showAzureDiskEncryptionStatus__46() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      output = __this.cli.output;
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 12, 33, function ___(__0, __1) { vmModel = __1;
        ...
        if (utils.ignoreCaseEquals(vmModel.storageProfile.osDisk.osType, "Linux")) {
          ...
          encryptionStatus.osVolumeEncrypted = "Unknown"; } ; return (function __$showAzureDiskEncryptionStatus__46(__then) {
          ...
          if (vmModel.storageProfile.osDisk.encryptionSettings) {
            ...
            if (utils.ignoreCaseEquals(vmModel.storageProfile.osDisk.osType, "Linux")) {
              ...
              if (utils.ignoreCaseEquals(vmModel.storageProfile.osDisk.osType, "Windows")) {
                extensionName = vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME;
                publisherName = vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_PUBLISHER; } ; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showAzureDiskEncryptionStatus__46() {



                  getOptions = { expand: "instanceView" };
                  return serviceClients.computeManagementClient.virtualMachineExtensions.get(resourceGroupName, name, extensionName, getOptions, __cb(_, __frame, 44, 90, function ___(__0, __2) { extensionStatus = __2; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$showAzureDiskEncryptionStatus__46() { if (e) {


                    extensionStatus = null; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$showAzureDiskEncryptionStatus__46() {
                ...
                if (((((extensionStatus) && utils.ignoreCaseEquals(extensionStatus.publisher, publisherName)) && utils.ignoreCaseEquals(extensionStatus.virtualMachineExtensionType, extensionName)) && utils.ignoreCaseEquals(extensionStatus.provisioningState, vmConstants.EXTENSIONS.EXTENSION_PROVISIONING_SUCCEEDED))) {
                  ...
                  if ((((!extensionStatus.settings.VolumeType || utils.ignoreCaseEquals(extensionStatus.settings.VolumeType, "All")) || utils.ignoreCaseEquals(extensionStatus.settings.VolumeType, "Data")) || (utils.stringIsNullOrEmpty(extensionStatus.settings.VolumeType)))) {
                    ...
                    if (utils.ignoreCaseEquals(extensionStatus.settings.EncryptionOperation, "EnableEncryption")) {
                      encryptionStatus.dataVolumesEncrypted = "Encrypted"; } ; } ; } ; __then(); }); }); } else { __then(); } ; })(function __$showAzureDiskEncryptionStatus__46() {
  ...
  disableAzureDiskEncryption: function disableAzureDiskEncryption__47(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, params, vmResult, vmExtensionProfile, disableAzureDiskEncryptionExtension, result, extensionName, publisherName, getOptions, extensionResult, statusMsg, vmModel, encryptionSettings, __this = this; var __frame = { name: "disableAzureDiskEncryption__47", line: 1981 }; return __func(_, this, arguments, disableAzureDiskEncryption__47, 3, __frame, function __$disableAzureDiskEncryption__47() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      params = { };
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 6, 34, function ___(__0, __2) { vmResult = __2;
        ...
        if (utils.ignoreCaseEquals(params.osType, "Linux")) {
          return _(new Error($("Disabling encryption is only supported for Windows virtual machines"))); } ;



        vmExtensionProfile = new VMExtensionProfile(__this.cli, params);
        disableAzureDiskEncryptionExtension = vmExtensionProfile.generateDisableAzureDiskEncryptionExtensionProfile(); return (function __$disableAzureDiskEncryption__47(_) {

          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ;
          return __this.cli.interaction.confirm($("This cmdlet disables encryption on the VM which may reboot the machine. Please save your work on the VM before confirming. Do you want to continue? [y/n] "), __cb(_, __frame, 27, 30, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -1980, 17, function ___(__0, __3) { return (function __$disableAzureDiskEncryption__47(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$disableAzureDiskEncryption__47() {




            return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, disableAzureDiskEncryptionExtension.profile, true, __cb(_, __frame, 32, 32, function ___(__0, __4) { result = __4;
              if ((!(result) || !utils.ignoreCaseEquals(result.provisioningState, vmConstants.EXTENSIONS.EXTENSION_PROVISIONING_SUCCEEDED))) {
              ...
              getOptions = { expand: "instanceView" };
              return serviceClients.computeManagementClient.virtualMachineExtensions.get(resourceGroupName, name, extensionName, getOptions, __cb(_, __frame, 47, 90, function ___(__0, __5) { extensionResult = __5;
                ...
                return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 66, 33, function ___(__0, __6) { vmModel = __6;
                  if ((!vmModel || !vmModel.storageProfile)) {


                    return _(new Error(util.format($("Virtual machine \"%s\" with valid storage profile is not found under the resource group \"%s\""), name, resourceGroupName))); } ; return (function __$disableAzureDiskEncryption__47(__then) {



                    if (((utils.ignoreCaseEquals(options.volumeType, "All") || utils.ignoreCaseEquals(options.volumeType, "OS")) || (utils.stringIsNullOrEmpty(options.volumeType)))) {
                      ...
                      vmModel.storageProfile.osDisk.encryptionSettings = encryptionSettings;
                      return virtualMachine.createOrUpdateVM(resourceGroupName, vmModel, false, __cb(_, __frame, 84, 28, _, true)); } else { __then(); } ; })(_); }, true)); }, true)); }, true)); }); }, true)); }, true)); }); }});
