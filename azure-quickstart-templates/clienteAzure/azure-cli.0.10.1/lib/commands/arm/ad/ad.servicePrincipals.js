...
exports.init = function(cli) {
  ...
  adSP.command("show").description($("Get Active Directory service principals")).option("--spn <spn>", $("the name of the service principal to return")).option("--objectId <objectId>", $("the object id of the service principal to return")).option("--search <search>", $("search display name of the service principal starting with the provided value")).execute(function __2(options, _) { var spn, objectId, search, subscription, client, progress, servicePrincipals, parameters, servicePrincipal; var __frame = { name: "__2", line: 52 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() {
      ...
      parameters = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function __$__2(__then) {
              ...
              if (spn) {
                ...
                return client.servicePrincipalOperations.list(parameters, __cb(_, __frame, 18, 64, function ___(__0, __1) { servicePrincipals = __1; __then(); }, true)); } else { return (function __$__2(__then) {
                  if (objectId) {
                    return client.servicePrincipalOperations.get(objectId, __cb(_, __frame, 20, 67, function ___(__0, __2) { servicePrincipal = __2;
                      if (servicePrincipal) {
                        servicePrincipals.push(servicePrincipal); } ; __then(); }, true)); } else {


                    parameters = { filter: (("startswith(displayName,'" + search) + "')") };
                    return client.servicePrincipalOperations.list(parameters, __cb(_, __frame, 26, 64, function ___(__0, __3) { servicePrincipals = __3; __then(); }, true)); } ; })(__then); } ; })(function __$__2() { _(null, null, true); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
  ...
  adSP.command("create [applicationId]").description($("Create Active Directory service principal")).usage("[options] <applicationId>").option("--applicationId <applicationId>", $("the application Id for which service principal is created")).execute(function __3(applicationId, options, _) { var subscription, client, spParams, servicePrincipal; var __frame = { name: "__3", line: 95 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      ...
      return withProgress(util.format($("Creating service principal for application %s"), applicationId), function __1(log, _) { var __frame = { name: "__1", line: 109 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          return client.servicePrincipalOperations.create(spParams, __cb(_, __frame, 1, 49, _, true)); }); }, __cb(_, __frame, 13, 29, function ___(__0, __2) { servicePrincipal = __2;
  ...
  adSP.command("delete [objectId]").description($("Deletes Active Directory service principal")).usage("[options] <objectId>").option("--objectId <objectId>", $("the object id of the service principal to delete")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).execute(function __4(objectId, options, _) { var subscription, client, progress; var __frame = { name: "__4", line: 125 }; return __func(_, this, arguments, __4, 2, __frame, function __$__4() {
      ...
      if (!objectId) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete service principal %s? [y/n] "), objectId), __cb(_, __frame, 5, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -124, 17, function ___(__0, __2) { return (function __$__4(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__4() {
          ...
          progress = cli.interaction.progress(util.format($("Deleting service principal %s"), objectId)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {
                ...
                return client.servicePrincipalOperations.deleteMethod(objectId, __cb(_, __frame, 13, 42, function __$__4() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__4() {
