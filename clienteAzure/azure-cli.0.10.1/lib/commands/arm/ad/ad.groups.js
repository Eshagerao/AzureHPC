...
function getSpecificGroups(client, objectId, search, _) { var parameters, group; var __frame = { name: "getSpecificGroups", line: 99 }; return __func(_, this, arguments, getSpecificGroups, 3, __frame, function __$getSpecificGroups() { return (function __$getSpecificGroups(__then) {
      if (search) {
        parameters = { filter: (("startswith(displayName,'" + search) + "')") };
        return client.groupOperations.list(parameters, __cb(_, __frame, 3, 34, _, true)); } else {

        return client.groupOperations.get(objectId, __cb(_, __frame, 5, 39, function ___(__0, __2) { group = __2;
