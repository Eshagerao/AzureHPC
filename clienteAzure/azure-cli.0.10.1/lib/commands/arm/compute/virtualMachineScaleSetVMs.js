...
exports.init = function(cli) {
  ...
  virtualMachineScaleSetVMsDeallocate.command("deallocate [resource-group] [name] [instance-id]").description($("The operation to deallocate a virtual machine scale set.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __1(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__1", line: 140 }; return __func(_, this, arguments, __1, 4, __frame, function __$__1() { return (function __$__1(__then) {
  ...
  virtualMachineScaleSetVMsDelete.command("delete [resource-group] [name] [instance-id]").description($("The operation to delete a virtual machine scale set.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __2(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__2", line: 178 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() { return (function __$__2(__then) {
  ...
  virtualMachineScaleSetVMsGet.command("show [resource-group] [name] [instance-id]").description($("The operation to get a virtual machine scale set virtual machine.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __3(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__3", line: 216 }; return __func(_, this, arguments, __3, 4, __frame, function __$__3() { return (function __$__3(__then) {
  ...
  virtualMachineScaleSetVMsGetInstanceView.command("get-instance-view [resource-group] [name] [instance-id]").description($("The operation to get a virtual machine scale set virtual machine.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __4(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__4", line: 257 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() { return (function __$__4(__then) {
  ...
  virtualMachineScaleSetVMsList.command("list [resource-group] [name]").description($("The operation to list virtual machine scale sets VMs.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __5(resourceGroup, name, options, _) { var subscription, computeManagementClient, result, nextPageLink, pageResult; var __frame = { name: "__5", line: 296 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() { return (function __$__5(__then) {
        ...
        cli.output.verbose(("resourceGroup = " + resourceGroup)); return (function __$__5(__then) {
          ...
          return computeManagementClient.virtualMachineScaleSetVMs.list(resourceGroup, name, __cb(_, __frame, 13, 67, function ___(__0, __3) { result = __3;
            nextPageLink = result.nextPageLink; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__5() { __more = false;
                var __8 = nextPageLink; if (__8) {
                  return computeManagementClient.virtualMachineScaleSetVMs.listNext(nextPageLink, __cb(_, __frame, 16, 73, function ___(__0, __4) { pageResult = __4;
                    ...
                    nextPageLink = pageResult.nextPageLink; while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$__5() {
  ...
  virtualMachineScaleSetVMsPowerOff.command("power-off [resource-group] [name] [instance-id]").description($("The operation to power off (stop) a virtual machine scale set.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __6(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__6", line: 347 }; return __func(_, this, arguments, __6, 4, __frame, function __$__6() { return (function __$__6(__then) {
  ...
  virtualMachineScaleSetVMsReimage.command("reimage [resource-group] [name] [instance-id]").description($("The operation to re-image a virtual machine scale set instance.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __7(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__7", line: 385 }; return __func(_, this, arguments, __7, 4, __frame, function __$__7() { return (function __$__7(__then) {
  ...
  virtualMachineScaleSetVMsRestart.command("restart [resource-group] [name] [instance-id]").description($("The operation to restart a virtual machine scale set.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __8(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__8", line: 423 }; return __func(_, this, arguments, __8, 4, __frame, function __$__8() { return (function __$__8(__then) {
  ...
  virtualMachineScaleSetVMsStart.command("start [resource-group] [name] [instance-id]").description($("The operation to start a virtual machine scale set.")).usage("[options] <resource-group> <name> <instance-id>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-d, --instance-id <instance-id>", $("instance-id")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __9(resourceGroup, name, instanceId, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__9", line: 461 }; return __func(_, this, arguments, __9, 4, __frame, function __$__9() { return (function __$__9(__then) {
