...
exports.init = function(cli) {
  ...
  shareSas.command("create [share] [permissions] [expiry]").description($("Generate shared access signature of storage share")).option("--share <share>", $("the storage share name")).option("--permissions <permissions>", $("the operation permissions combining symbols of r(Read)/w(Write)/d(Delete)/l(List)")).option("--start <start>", $("the UTC time at which the SAS becomes valid")).option("--expiry <expiry>", $("the UTC time at which the SAS expires")).option("--policy <policy>", $("the stored access policy identifier")).addStorageAccountOption().execute(createShareSas);
  ...
  file.command("list [share] [path]").usage("[options] [share] [path]").description($("List storage files in the specified share under specific path")).option("--share <share>", $("the storage share name")).option("-p, --path <path>", $("the path to be listed")).option("--sas <sas>", $("the shared access signature of the storage file share")).addStorageAccountOption().execute(listFiles);
  ...
  file.command("download [share] [path] [destination]").usage("[options] [share] [path] [destination]").description($("Download the specified storage file")).option("--share <share>", $("the storage share name")).option("-p, --path <path>", $("the path to the storage file")).option("-d, --destination <destination>", $("path to the destination file or directory")).option("-m, --checkmd5", $("check md5sum for the downloaded file")).option("-q, --quiet", $("overwrite the destination file without confirmation")).option("--sas <sas>", $("the shared access signature of the storage file share")).addStorageAccountOption().execute(downloadFile);
  ...
  fileSas.command("create [share] [path] [permissions] [expiry]").description($("Generate shared access signature of storage file")).option("--share <share>", $("the storage share name")).option("-p, --path <path>", $("the path to the storage file")).option("--permissions <permissions>", $("the operation permissions combining symbols of r(Read)/w(Write)/d(Delete)")).option("--start <start>", $("the UTC time at which the SAS becomes valid")).option("--expiry <expiry>", $("the UTC time at which the SAS expires")).option("--policy <policy>", $("the stored access policy identifier")).addStorageAccountOption().execute(createFileSas);
  ...
  function createShare(share, options, _) { var fileService, operation, tips, storageOptions, created; var __frame = { name: "createShare", line: 330 }; return __func(_, this, arguments, createShare, 2, __frame, function __$createShare() {
  ...
  function deleteShare(share, options, _) { var fileService, operation, tips, storageOptions, force; var __frame = { name: "deleteShare", line: 357 }; return __func(_, this, arguments, deleteShare, 2, __frame, function __$deleteShare() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function showShare(share, options, _) { var fileService, operation, tips, storageOptions, properties, getStatsOperation, stats; var __frame = { name: "showShare", line: 392 }; return __func(_, this, arguments, showShare, 2, __frame, function __$showShare() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function setShare(share, options, _) { var fileService, tips, properties, getPropertiesOperation, storageOptions, setPropertiesOperation; var __frame = { name: "setShare", line: 423 }; return __func(_, this, arguments, setShare, 2, __frame, function __$setShare() {
      fileService = getFileServiceClient(options);
  ...
  function listShares(prefix, options, _) { var fileService, listOperation, tips, storageOptions, shares; var __frame = { name: "listShares", line: 458 }; return __func(_, this, arguments, listShares, 2, __frame, function __$listShares() {
      fileService = getFileServiceClient(options);
  ...
  function createShareSas(share, permissions, expiry, options, _) { var __frame = { name: "createShareSas", line: 490 }; return __func(_, this, arguments, createShareSas, 4, __frame, function __$createShareSas() {
      return createSas(share, null, permissions, expiry, options, true, __cb(_, __frame, 1, 4, function __$createShareSas() { _(); }, true)); }); };





  function createFileSas(share, path, permissions, expiry, options, _) { var __frame = { name: "createFileSas", line: 497 }; return __func(_, this, arguments, createFileSas, 5, __frame, function __$createFileSas() {
      return createSas(share, path, permissions, expiry, options, false, __cb(_, __frame, 1, 4, function __$createFileSas() { _(); }, true)); }); };





  function createSas(share, path, permissions, expiry, options, isShare, _) { var fileService, start, output, sharedAccessPolicy, tips, result, directory, file; var __frame = { name: "createSas", line: 504 }; return __func(_, this, arguments, createSas, 6, __frame, function __$createSas() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1; return (function __$createSas(__then) {
          ...
          if (!isShare) {
            return interaction.promptIfNotGiven($("File path: "), path, __cb(_, __frame, 5, 25, function ___(__0, __2) { path = __2; __then(); }, true)); } else { __then(); } ; })(function __$createSas() { return (function __$createSas(__then) {
  ...
  function createSharePolicy(share, name, options, _) { var createPolicySettings, policies; var __frame = { name: "createSharePolicy", line: 564 }; return __func(_, this, arguments, createSharePolicy, 3, __frame, function __$createSharePolicy() {
  ...
  function listSharePolicy(share, options, _) { var listPolicySettings, policies; var __frame = { name: "listSharePolicy", line: 584 }; return __func(_, this, arguments, listSharePolicy, 2, __frame, function __$listSharePolicy() {
  ...
  function showSharePolicy(share, name, options, _) { var showPolicySettings, policy; var __frame = { name: "showSharePolicy", line: 602 }; return __func(_, this, arguments, showSharePolicy, 3, __frame, function __$showSharePolicy() {
  ...
  function setSharePolicy(share, name, options, _) { var setPolicySettings, policies; var __frame = { name: "setSharePolicy", line: 617 }; return __func(_, this, arguments, setSharePolicy, 3, __frame, function __$setSharePolicy() {
  ...
  function deleteSharePolicy(share, name, options, _) { var deletePolicySettings, policies; var __frame = { name: "deleteSharePolicy", line: 637 }; return __func(_, this, arguments, deleteSharePolicy, 3, __frame, function __$deleteSharePolicy() {
  ...
  function listFiles(share, path, options, _) { var fileService, listOperation, tips, storageOptions, listResults, setUriFunc; var __frame = { name: "listFiles", line: 661 }; return __func(_, this, arguments, listFiles, 3, __frame, function __$listFiles() {
      fileService = getFileServiceClient(options);
      ...
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 3, 24, function ___(__0, __1) { share = __1;
        ...
        startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$listFiles() {
              ...
              return performStorageOperation(listOperation, __cb(_, __frame, 16, 20, function ___(__0, __2) { listResults = __2; _(null, null, true); }, true), share, path, storageOptions); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$listFiles() {
  ...
  function deleteFile(share, path, options, _) { var fileService, operation, tips, storageOptions, force, result, directory, file; var __frame = { name: "deleteFile", line: 710 }; return __func(_, this, arguments, deleteFile, 3, __frame, function __$deleteFile() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function uploadFile(source, share, path, options, _) { var fileService, storageOptions, force, fsStatus, pathIsDirectory, remoteFileExists, directory, file, result, summary, printer, intervalId, succeeded, uploadFileResult; var __frame = { name: "uploadFile", line: 751 }; return __func(_, this, arguments, uploadFile, 4, __frame, function __$uploadFile() {
      fileService = getFileServiceClient(options);
                        ...
                        if (path) {
                          ...
                          file = result.basename; return (function __$uploadFile(_) {
                            ...
                            return performStorageOperation(getStorageFileOperation(fileService, "doesFileExist"), __cb(_, __frame, 42, 10, function ___(__0, __3) {
                              ...
                              var __2 = __3.exists; return _(null, __2); }, true), share, directory, file, storageOptions); })(__cb(_, __frame, -750, 18, function ___(__0, __9) { return (function __$uploadFile(__then) { if (__9) {
                                ...
                                remoteFileExists = true; __then(); } else { return (function __$uploadFile(_) {
                                  ...
                                  var __2 = pathIsDirectory; if (__2) { return _(null, __2); } ; return performStorageOperation(getStorageFileOperation(fileService, "doesDirectoryExist"), __cb(_, __frame, 54, 36, function ___(__0, __4) {
                                    ...
                                    var __3 = __4.exists; return _(null, __3); }, true), share, path); })(__cb(_, __frame, -750, 18, function ___(__0, __10) { return (function __$uploadFile(__then) { if (__10) {
                          ...
                          var __3 = remoteFileExists; if (__3) { return _(null, __3); } ; return performStorageOperation(getStorageFileOperation(fileService, "doesFileExist"), __cb(_, __frame, 87, 30, function ___(__0, __5) {
                            ...
                            var __4 = __5.exists; return _(null, __4); }, true), share, directory, file, storageOptions); })(__cb(_, __frame, -750, 18, function ___(__0, __13) { return (function __$uploadFile(__then) { if (__13) {
  ...
  function downloadFile(share, path, destination, options, _) { var fileService, storageOptions, force, result, directory, file, stat, operation, summary, printer, intervalId, downloadedFile; var __frame = { name: "downloadFile", line: 898 }; return __func(_, this, arguments, downloadFile, 4, __frame, function __$downloadFile() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
            ...
            return utils.fileExists(destination, __cb(_, __frame, 36, 14, function ___(__0, __4) { return (function __$downloadFile(__then) { if (__4) { return (function __$downloadFile(__then) {
                ...
                if (!logger.format().json) {
                  intervalId = setInterval(printer, 1000); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$downloadFile() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$downloadFile() {
                            ...
                            return performStorageOperation(operation, __cb(_, __frame, 61, 23, function ___(__0, __6) { downloadedFile = __6; __then(); }, true), share, directory, file, destination, storageOptions); }); })(function ___(e, __result) { __catch(function __$downloadFile() { if (e) {
                        ...
                        printer(true);
                        clearInterval(printer); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$downloadFile() {
  ...
  function getStorageFileProperties(share, path, options, _) { var fileService, storageOptions, file, result, propertiesOperation, tips; var __frame = { name: "getStorageFileProperties", line: 980 }; return __func(_, this, arguments, getStorageFileProperties, 3, __frame, function __$getStorageFileProperties() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function doesStorageFileExist(share, path, options, _) { var fileService, storageOptions, propertiesOperation, result; var __frame = { name: "doesStorageFileExist", line: 1007 }; return __func(_, this, arguments, doesStorageFileExist, 3, __frame, function __$doesStorageFileExist() {
      fileService = getFileServiceClient(options);
      storageOptions = getStorageFileOperationDefaultOption();
  ...
  function createDirectory(share, path, options, _) { var fileService, operation, tips, storageOptions, directoryResult; var __frame = { name: "createDirectory", line: 1018 }; return __func(_, this, arguments, createDirectory, 3, __frame, function __$createDirectory() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function deleteDirectory(share, path, options, _) { var fileService, operation, tips, storageOptions, force; var __frame = { name: "deleteDirectory", line: 1040 }; return __func(_, this, arguments, deleteDirectory, 3, __frame, function __$deleteDirectory() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
        return interaction.promptIfNotGiven($("Path to the directory to be created: "), path, __cb(_, __frame, 3, 23, function ___(__0, __2) { path = __2;
  ...
  function startFileCopy(sourceUri, destShare, options, _) { var startCopyParams; var __frame = { name: "startFileCopy", line: 1081 }; return __func(_, this, arguments, startFileCopy, 3, __frame, function __$startFileCopy() {
  ...
  function showFileCopy(share, path, options, _) { var showCopyParams; var __frame = { name: "showFileCopy", line: 1091 }; return __func(_, this, arguments, showFileCopy, 3, __frame, function __$showFileCopy() {
      showCopyParams = {
  ...
  function stopFileCopy(share, path, copyid, options, _) { var getStopOperation, stopCopyParams; var __frame = { name: "stopFileCopy", line: 1103 }; return __func(_, this, arguments, stopFileCopy, 4, __frame, function __$stopFileCopy() {
